...
created_by: "Mark Crowe, Scott Murphy"
...
The Space Quest series is Sierra On-Line's beloved science fiction comedy adventure franchise, created by [[Mark Crowe]] and [[Scott Murphy]]—collectively known as the "Two Guys from Andromeda."[^ref-1] Spanning seven games from 1986 to 1995, the series follows the misadventures of Roger Wilco, a hapless janitor who repeatedly stumbles into saving the galaxy despite his best efforts to avoid responsibility.[^ref-2] [[Josh Mandel]] contributed significantly to the series, co-designing Space Quest VI with Murphy after the Two Guys parted ways.

Distinguished by its satirical humor, pop culture parodies, and willingness to kill players in creative and often hilarious ways, Space Quest carved out a unique niche in the adventure game landscape.[^ref-3] Where King's Quest embraced fairy tale sincerity, Space Quest gleefully mocked science fiction tropes while crafting genuinely engaging adventures.
...
[[Mark Crowe]] and [[Scott Murphy]] created Space Quest while working at Sierra, developing the series' distinctive voice through collaborative writing and design.[^ref-4] Their comedic sensibilities complemented each other—Crowe focused on art and visual gags while Murphy handled programming and wordplay.

The duo maintained creative control through Space Quest III, where they literally inserted themselves into the game as captive programmers Roger must rescue from the evil ScumSoft corporation (a parody of software publishers).[^ref-5] After SQ3, the Two Guys worked separately:
...
### Space Quest VII
Development began in the mid-1990s but was cancelled when Sierra shifted focus away from adventure games.[^ref-6] Multiple concepts were explored, including a prequel and direct sequel.

### SpaceVenture
Mark Crowe and Scott Murphy reunited for a Kickstarter-funded spiritual successor, though development faced significant delays.[^ref-7]
...
| Collection | Store |
|------------|-------|
| Space Quest 1+2+3 | [GOG](https://www.gog.com/game/space_quest_1_2_3) |
| Space Quest 4+5+6 | [GOG](https://www.gog.com/game/space_quest_4_5_6) |
| Space Quest Collection | [Steam](https://store.steampowered.com/app/10110/Space_Quest_Collection/) |

> [!tip] Buying Notes
> - **SQ1 VGA (1991)** - Steam only! GOG's SQ 1+2+3 includes the EGA original only, not the VGA remake

### Compatibility
- **[ScummVM](https://www.scummvm.org/)** - Full support for all entries
- Original DOS versions playable via [DOSBox](https://www.dosbox.com/)
...
[^ref-4]: [The Digital Antiquarian - Space Quest](https://www.filfre.net/2016/02/space-quest/) – Two Guys collaboration history
