...
The approach was deliberately experimental: "There is no real goal - you're an innocent thrust into a situation where suddenly all these people are dying and things are happening."[^ref-5]
...
The Colonel's Bequest pioneered a system where story events occur on their own timeline, regardless of player location.[^ref-3] As developer Josh Mandel explained: "It gave the game a better sense of realism, that you could be in one place and miss something that was going on in another place."[^ref-6]
...
Critics praised the series' atmospheric presentation and innovative storytelling. Games International called The Colonel's Bequest "solid genre stuff" with "a charm all of its own."[^ref-7] Modern retrospectives recognize the games as "genuinely groundbreaking" in interactive narrative design.[^ref-6]
...
| Title | Store |
|-------|-------|
| The Colonel's Bequest | [GOG](https://www.gog.com/game/the_colonels_bequest) |
| The Dagger of Amon Ra | [GOG](https://www.gog.com/game/the_dagger_of_amon_ra) |

### Compatibility
- **[ScummVM](https://www.scummvm.org/)** - Full support for both entries
...
[^ref-6]: [PC Gamer - Laura Bow Retrospective](https://www.pcgamer.com/30-years-later-sierras-laura-bow-mysteries-are-still-a-treasure/) – Josh Mandel quote and "groundbreaking" assessment
[^ref-7]: [Wikipedia - The Colonel's Bequest](https://en.wikipedia.org/wiki/The_Colonel's_Bequest) – Games International review quote
[^ref-8]: [Steam - Laura Bow and the Mechanical Codex](https://store.steampowered.com/app/2549910/Laura_Bow_and_the_Mechanical_Codex/) – Revival sequel announcement
