...
> — [[Scott Murphy]], co-creator of Space Quest[^ref-1]

## The Philosophy of "Learning by Dying"
...
### Space Quest: Where Janitors Go to Die
...
## Famous Death Messages

Sierra death messages became an art form. Some highlights:

**Space Quest II:** "Too bad you've failed miserably and doomed all your people to a horrible death" (cut from final release)

**Space Quest - Vohaul Strikes Back:** "I'm still amazed you survived this long"

**Mixed-Up Mother Goose Reference:** "Perhaps you'd like to try one of our less challenging games like 'Mixed Up Mother Goose?'"[^ref-10]

**Quest for Glory I VGA (lockpick nose):** "You delicately insert the lockpick into your left nostril. Unfortunately, you push it too far, causing yourself a cerebral hemorrhage"

## Computer Gaming World's "15 Best Ways to Die" (1996)

In November 1996, Computer Gaming World published their definitive ranking of PC gaming's most memorable death scenes.[^ref-7] Sierra dominated the list:

| Rank | Game | Death Description |
|------|------|-------------------|
...
But the deaths themselves? They live on in memory—funny, frustrating, and utterly unforgettable.

## A Final Word

Sierra's approach to death reflected something important about game design: failure can be fun. Every death was a punchline, every game over screen a comedy sketch. Players didn't just tolerate the frequent deaths—they sought them out, saved before dangerous choices specifically to see what would happen.

In an age of infinite retries and gentle tutorials, there's something to be said for games that turned player death into an art form. Sierra didn't just kill you—they entertained you while doing it.

---

*"Save early and often, my friends!"* — Universal Sierra wisdom

## See Also

- [[Protagonist Guide]] - Meet the heroes who died so many times
- [[Engine Index]] - The technology behind the deaths
- [[Designer Index]] - The minds behind the mayhem
...
[^ref-7]: [Computer Gaming World – November 1996 (Issue 148)](https://archive.org/details/Computer_Gaming_World_Issue_148) – "The Best Ways To Die in A PC Game" list: Space Quest III at #2
[^ref-8]: [SpaceQuest.net – SQ4 Easter Eggs](https://spacequest.net/sq4/eastereggs/) – Ortega death scene parodies "This is your brain on drugs" PSA
[^ref-9]: [SpaceQuest.net – SQ5 Cheats & Debug](https://spacequest.net/sq5/cheatdebug/) – Hidden death message viewer button
[^ref-10]: [TV Tropes – Space Quest V](https://tvtropes.org/pmwiki/pmwiki.php/VideoGame/SpaceQuestVTheNextMutation) – Mixed-Up Mother Goose death message reference
[^ref-11]: [Sierra Newsletter Winter 1988](https://www.mocagh.org/sierra/sierranews-winter88.pdf) – Roberta Williams on animating female protagonist deaths
