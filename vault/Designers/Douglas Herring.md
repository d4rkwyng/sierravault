...
Before entering the video game industry, Douglas Herring served as Art Director at KIXE-TV, the PBS affiliate in Redding, California, for six years from 1982 to 1988.[^ref-2] His duties at the television station were extensive, encompassing graphic design, set design and construction, photography, camera operation (both field and studio), lighting, and video editing. He specialized in real-time character generator work for live productions such as sports events, parades, auctions, and pledge breaks, and directed several projects including contract productions for the State of California.[^ref-2]
