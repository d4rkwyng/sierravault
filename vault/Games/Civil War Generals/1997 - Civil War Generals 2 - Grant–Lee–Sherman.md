---
title: 'Civil War Generals 2: Grant, Lee, Sherman'
release_year: 1997
developer: Sierra Entertainment
designer: [Charles Moylan, Jeffrey Fiske, Steve Grammont]
publisher: Sierra On-Line
genre: Strategy
platforms: [Microsoft Windows, PC, Windows 95, Windows 3.1]
...
Civil War Generals 2 places players at the heart of America's defining conflict, offering unusual control over the campaigns that shaped the nation's destiny. Unlike its predecessor which focused exclusively on Robert E. Lee's Confederate perspective, this sequel allows command of both Union and Confederate forces across multiple theaters of war[^ref-13]. The game spans the entire conflict from 1861 to 1865, featuring over 200 predesigned scenarios and 17 total campaigns that recreate the strategic challenges faced by history's greatest military minds[^ref-14].
