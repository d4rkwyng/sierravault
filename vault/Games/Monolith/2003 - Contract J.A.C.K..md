...
Contract J.A.C.K. (where J.A.C.K. stands for "Just Another Contract Killer") is a first-person shooter developed by [[Monolith Productions]] and published by [[Sierra On-Line|Sierra Entertainment]] in November 2003.[^ref-1] Serving as a prequel to *No One Lives Forever 2: A Spy in H.A.R.M.'s Way*, the game shifts perspective from series protagonist Cate Archer to John Jack, a ruthless contract killer working for the villainous organization H.A.R.M.[^ref-2] Unlike its predecessors, which balanced stealth gameplay with action and humor, Contract J.A.C.K. strips away virtually all espionage elements to focus purely on run-and-gun shooting.[^ref-3]

The game was released at a budget price point of $29.99, reflecting its nature as a standalone expansion rather than a full sequel.[^ref-4] Set between the events of the original *No One Lives Forever* and its sequel, the story follows Jack as he battles a rival Italian criminal organization called Danger Danger that threatens to destroy H.A.R.M.[^ref-5] Despite using the same LithTech Jupiter engine as the critically acclaimed *NOLF 2*, the game was poorly received by critics, earning a Metacritic score of 56 out of 100.[^ref-1]

Contract J.A.C.K. represents Monolith's attempt to create a pure action experience within the *No One Lives Forever* universe, a decision that proved controversial among fans who valued the series' distinctive blend of stealth, gadgetry, and spy parody humor.[^ref-6] The game remains largely unavailable for legal purchase today due to complex licensing disputes between Activision Blizzard and WB Games over the rights to Monolith's back catalog.[^ref-7]
...
> **Series:** No One Lives Forever
> **Protagonist:** John Jack
> **Sierra Lineage:** Vivendi Universal Games Era

## Story Summary

The game opens with John Jack, described as the world's busiest professional killer, being recruited by H.A.R.M. Director Dmitrij Volkov for a critical mission.[^ref-8] An Italian criminal organization called Danger Danger, led by the psychotic Il Pazzo, has declared war on H.A.R.M. and plans to destroy the evil syndicate.[^ref-9] Jack must eliminate this rival organization before they can execute their plans, traveling across multiple locations including Italy, Czechoslovakia, and even outer space.[^ref-10]

The narrative unfolds across seven chapters as Jack reluctantly carries out H.A.R.M.'s orders, battling waves of Danger Danger thugs and Czechoslovakian soldiers along the way.[^ref-11] Unlike Cate Archer, who was characterized by witty dialogue and moral complexity, Jack is presented as a nearly silent protagonist with only two lines of dialogue throughout the entire game.[^ref-12] The tone has been compared to *Pulp Fiction*, with lead designer Craig Hubbard noting that "there's still plenty of humor, but the style isn't as campy."[^ref-10]

The story serves primarily as a vehicle for action set pieces, including a memorable sequence where Jack pilots a machine gun-equipped Vespa through the Italian countryside.[^ref-13] The game's ending is believed to explain why Volkov appears confined to a wheelchair and covered in a full body cast during the events of *No One Lives Forever 2*.[^ref-5] Jack's characterization as a "rugged anti-hero" stands in stark contrast to the glamorous spy thriller aesthetic of the main series.[^ref-2]

Hubbard explained the protagonist's distinctive name in a developer interview: "The protagonist's real name is John Jack (instead of just one cliché action hero name, he has two!), but people call him Contract Jack because he's sort of a freelance 'problem solver' of questionable moral standing."[^ref-10]

## Gameplay

### Interface and Controls

Contract J.A.C.K. presents a straightforward first-person shooter experience using standard WASD controls and mouse aiming.[^ref-7] The game supports keyboard, mouse, and gamepad input devices.[^ref-14] Players can access a quick save function via F6, with the game also providing auto-saves at the beginning of each level and checkpoint saves throughout missions.[^ref-15] The talk console, accessed by pressing T, allows entry of cheat codes for those seeking assistance.[^ref-16]

Unlike its predecessors, the game completely removes the ability to search bodies for items and ammunition—dead enemies simply fade away after being killed.[^ref-17] There is no map system, and the compass rarely provides destination markers, forcing players to navigate environments through exploration.[^ref-3] The difficulty setting can be changed at any time during gameplay, with normal difficulty recommended for first-time players.[^ref-15]

### Structure and Progression

The game consists of 15 missions spread across 7 chapters, despite retail packaging claims of 10 levels.[^ref-18] The campaign can be completed in approximately four to five hours, making it significantly shorter than previous entries in the series.[^ref-4] Unlike *NOLF* and *NOLF 2*, which featured skill progression systems allowing Cate Archer to upgrade her abilities, Jack has no upgrade paths available—he cannot increase his health or armor values.[^ref-17]
...
- **Chapter 7:** Final confrontation with Il Pazzo[^ref-17]

### Puzzles and Mechanics

Contract J.A.C.K. explicitly abandons the stealth, gadgetry, and puzzle-solving that characterized the *No One Lives Forever* series.[^ref-6] As one walkthrough guide emphasized: "Forget almost everything you learned in NOLF and NOLF 2 - there is no stealth in THIS game. This is strictly a shooter."[^ref-19] The gameplay focuses entirely on action, with wave after wave of enemies spawning throughout levels.[^ref-20]

The game features a variety of weapons including the Beretta 81FS pistol, Desert Eagle Mark I, Sterling L2A3 submachine gun, AK-47 assault rifle, and the fictional Bacalov Corrector hand cannons prominently featured on the retail packaging.[^ref-21] However, several weapons contain anachronistic errors—the Desert Eagle wasn't introduced until 1982, making it out of place in the 1960s setting.[^ref-21] Vehicle sections allow Jack to pilot assault vehicles and the aforementioned armed Vespa, though controls were criticized as awkward.[^ref-22]

The game includes multiplayer modes supporting 2-16 players via Internet or LAN connection, featuring Deathmatch, Team Deathmatch, Doomsday, and Demolition modes.[^ref-15] However, critics noted that most multiplayer content was already available as a free patch for *NOLF 2*.[^ref-23]
...
GameSpot awarded the game 5.9 out of 10, with reviewer Brett Todd calling it "merely a mediocre shoot-'em-up that can be finished in four hours."[^ref-4] Todd noted that "the sense of humor, varied mission design, nifty Bond-inspired thingamajigs, and even the groovy 1960s threads have been swapped for a straight focus on action that strips the franchise of its identity and charm."[^ref-4]

IGN scored the game 6.1 out of 10, with Tom McNamara opening his review with "How the mighty have fallen."[^ref-3] He criticized the removal of core series elements: "Gone are the gadgets, the storyline, most of the humor and satire, most of the random overheard conversations, all of Cate Archer, stealth and dossiers scattered throughout the level."[^ref-3]

GameSpy gave it 3 out of 5 stars (75/100), with Sal Accardo noting that "NOLF fans will likely find it lacking most of the series' charm, and as an action title, it feels strangely unpolished, falling victim to any number of basic problems."[^ref-22]

PC Gamer awarded 63%, with Norman Chan writing: "Fun, but too short and shallow to be a full-priced expansion pack."[^ref-13] He added: "I kept on wondering when the game would pick up, and it just never did."[^ref-13]

Game Informer gave 5.5 out of 10, with editor Andy McNamara stating the game "manages to take out all the good things about the series (like an entertaining story, nifty Bond-esque gadgets, and interesting gameplay), and replace it with pure, uninspired action."[^ref-23]

GMR Magazine scored it 50/100, calling it "the inferior prequel to the outstanding 'No One Lives Forever' series, having none of the charm, humor, or creative gameplay of the other games under the NOLF umbrella."[^ref-24]

ActionTrip provided one of the few positive reviews at 80/100: "For thirty bucks though, I would advise shooter fans not to miss out on the opportunity to hear some fun dialogue and engage in a very entertaining fast-paced action experience with lots of personality and gallons upon gallons of animated blood."[^ref-24]

Computer Games Magazine awarded only 40/100, stating the game "lacks the slightest spark of life or inspiration."[^ref-24]

GamerFeed gave the lowest score at 30/100, questioning: "To be brutally honest, I'm not entirely sure why Monolith wasted their time making this game, other than to cash in on the franchise."[^ref-24]

GameZone awarded 6.3 out of 10, with Mike David calling it an "incredibly inferior prequel to the No One Lives Forever games" where "gone are the stealth weapons like the piano wire, sleeping gas, gone is the clever voice-overs done by Cate Archer."[^ref-8]

Game Over Online gave 60/100, noting that "Jack may have all the guns and firepower, but he lacks finesse. And he reminds us of why we like to watch heroes like James Bond. It's not all about the big bangs and fiery explosions. It's the martinis, women and one-liners that keep us coming back for more."[^ref-24]

French publication Jeuxvideo.com scored the game 13 out of 20, with reviewer Dinowan commenting that "Monolith nous livre un soft bien bourrin, un peu trop même" (Monolith delivers a very action-heavy game, perhaps too much so).[^ref-25]

### Modern Assessment

The game's reputation has not improved with time. Contract J.A.C.K. was named the #4 Worst Game of 2003 by Computer Games Magazine.[^ref-18] Retrospective analyses consistently view the game as a low point for the franchise, with Hardcore Gaming 101 concluding that "J.A.C.K leaves a bitter taste in the fans of the series by serving them a half baked game, rushed to the market without the labor of love that characterized the earlier titles."[^ref-6]

Gaming Pastime's retrospective noted that "Contract J.A.C.K. tells the weakest and most forgettable story in the series so far" and that "almost everything that made the previous games unique is missing."[^ref-26] The Sierra Chest described the game as "a low note in the highly praised No One Lives Forever series and even seemed to be put on the store shelves in a format that lacked what was originally planned, with re-used graphics, sounds, music and hardly a story line or character depth."[^ref-27]

**Aggregate Scores:**
- **Metacritic:** 56/100 (20 critic reviews: 10% positive, 60% mixed, 30% negative)[^ref-24]
- **Metacritic User Score:** 5.8/10 (24 ratings)[^ref-24]
- **MobyGames Critics Average:** 60%[^ref-18]
- **MobyGames:** 6.2/10[^ref-28]
- **IMDB:** 5.7/10 (94 ratings)[^ref-12]
- **Amazon Customer Reviews:** 2.6/5 stars (45 reviews)[^ref-29]
- **MyAbandonware User Rating:** 4.47/5[^ref-30]
...
The game recycled extensive assets from *No One Lives Forever 2*, including sounds, music, weapons, items, enemies, and interface elements.[^ref-22] Most of the soundtrack was taken directly from *NOLF 2* without significant modification.[^ref-6] This approach allowed for the compressed development timeline but contributed to criticism that the game felt like a rushed effort.

Originally, the game was conceived with a different narrative structure. In early previews, Monolith described the story as beginning "with Jack hurtling towards the sun" with "much of the game would be told through flashback."[^ref-33] This concept was scrapped at some point during development, resulting in the more straightforward linear narrative of the final product.[^ref-33]

The game went gold on October 31, 2003, more than a week before its November 11 ship date.[^ref-34] A demo was made available on November 6, 2003, though it utilized FilePlanet's Beta Protection System requiring registration keys and internet verification.[^ref-35]
...
Contract J.A.C.K. runs on the LithTech Jupiter engine, the same technology powering *No One Lives Forever 2*.[^ref-1] The engine supports both single-player and multiplayer modes, with online play for 2-16 players.[^ref-14] However, unlike *NOLF 2* which featured skill progression systems, Contract J.A.C.K. removed all upgrade paths, limiting the engine's RPG-lite elements.[^ref-5]

The game includes level-building tools allowing players to create and share mods online, though the modding community remained relatively small.[^ref-29] Several community-created patches have been developed to address compatibility issues with modern systems.[^ref-7]

### Technical Specifications

**System Requirements:**[^ref-14]
...
The most significant cut content involved the game's original narrative framing device. According to GameSpy's preview coverage: "when we previewed the game earlier this year, we were told that it would start with Jack hurtling towards the sun and much of the game would be told through flashback. Obviously, that idea was scrapped at some point."[^ref-33]

The German version received extensive censorship, removing all blood effects, death cries, ragdoll physics for corpses, and the ability to set enemies on fire.[^ref-18]

### Version History

| Version | Date | Region | Notes |
|---------|------|--------|-------|
| 1.0 | November 11, 2003 | USA | Initial release[^ref-36] |
| 1.0 | November 21, 2003 | Europe | European release[^ref-18] |
| 1.0 | November 28, 2003 | Japan | Japanese release via CyberFront[^ref-18] |
| 1.0 | December 12, 2003 | Poland | Polish release via Cenega[^ref-18] |
| 1.0 | February 2004 | Russia | Russian release via Soft Club[^ref-18] |
| 1.1 | November 12, 2003 | UK/US | Patch released one day before shipping, primarily multiplayer fixes, added Polish and Russian language support[^ref-37]|
| Budget | 2005 | France | Mindscape "Hits Collection" re-release[^ref-18] |

### Technical Issues

The game exhibits several known issues on modern systems:[^ref-7]
...
Community fixes exist for mouse and ammo issues through PCGamingWiki.[^ref-7] A widescreen compatibility fix is also available.[^ref-37]
...
**Trivia:**
- The retail box claims ten missions, but the game only contains seven chapters with 15 total missions.[^ref-18]
- Jack has only two lines of dialogue throughout the entire game.[^ref-12]
- The German package included a full version of *NOLF 2*.[^ref-32]
- The Bacalov Corrector hand cannons prominently featured on the box are only available near the end of the game.[^ref-8]
- The Man-Handler weapon was designed by Dr. Harij while trapped on the Moon.[^ref-17]

## Voice Cast

| Character | Voice Actor |
|-----------|-------------|
| John Jack | Jock Blaney[^ref-12] |
| Il Pazzo | John Armstrong[^ref-12] |
| Louie Franco | David Gehrman[^ref-12] |
| H.A.R.M. Guards | Ken Boynton[^ref-12] |
| Thugs | Collin Byrne[^ref-12] |
...
Contract J.A.C.K. was not included in any major compilation releases. Unlike its predecessors, which received Game of the Year editions, the game's poor reception prevented any enhanced re-releases.[^ref-27]

### Fan Projects

Despite receiving "discouraging ratings from reviewers," Contract J.A.C.K. remains modifiable, allowing community members to create changes to models, gameplay, and maps.[^ref-40] The modding community has produced compatibility patches for modern operating systems, widescreen fixes, and various quality-of-life improvements.[^ref-7]

### Preservation Status

The game remains commercially unavailable due to complex licensing disputes. PCGamingWiki notes: "The game remains unavailable for purchase due to licensing issues between Activision Blizzard (as successors of Sierra Entertainment) and WB Games (as current owners of developer Monolith Productions)."[^ref-7]

Night Dive Studios, known for republishing classic PC games like *System Shock 2*, has expressed interest in the *No One Lives Forever* franchise. CEO Stephen Kick has stated: "I'm never going to stop. It'll happen one way or another."[^ref-39] However, rights negotiations have been complicated by paper contracts between Sierra, Fox, and Monolith that predate digital record-keeping.[^ref-41]

Larry Kuperman of Night Dive noted: "We weren't meeting with a lot of enthusiasm" when approaching rights holders about potential re-releases.[^ref-41] The studio filed trademarks for games in the series but notably excluded Contract J.A.C.K., with Kick explaining: "We had filed for Contract J.A.C.K., but we don't really consider that to be part of the franchise. So we were going to just leave that by the wayside."[^ref-42]

The game is currently available through abandonware sites and Internet Archive preservation projects, with community-created patches enabling play on modern Windows 10 and 11 systems with widescreen support.[^ref-43]

### Related Publications

- **Game Manual:** Included with retail release, covering controls, interface, and gameplay mechanics[^ref-15]
...
The game is currently unavailable through legitimate digital storefronts due to ongoing licensing disputes.[^ref-7]

**Preservation / Abandonware:**
- [Internet Archive – Contract J.A.C.K. USA](https://archive.org/details/ContractJACKUSA) – 4,518 views[^ref-36]
- [Internet Archive – Contract J.A.C.K. Europe](https://archive.org/details/Contract_J.A.C.K._Europe) – 1,008 views[^ref-9]
- [MyAbandonware](https://www.myabandonware.com/game/contract-j-a-c-k-dvt)[^ref-30]
...
The game's ending is believed to explain Dmitrij Volkov's condition in *NOLF 2*, where he appears confined to a wheelchair and covered in a full body cast.[^ref-5] However, the game lacks the narrative depth to meaningfully expand upon series lore. It does not feature the UNITY organization at all, focusing entirely on the conflict between H.A.R.M. and Danger Danger.[^ref-5]

Night Dive Studios' exclusion of Contract J.A.C.K. from their trademark filings suggests the industry does not consider it a core part of the franchise.[^ref-42] The studio characterized the main series games as worthy of preservation while dismissing the spinoff as expendable—a sentiment shared by most fans and critics.
