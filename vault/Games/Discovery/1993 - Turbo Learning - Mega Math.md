---
title: 'Turbo Learning: Mega Math'
release_year: 1993
developer: Jeff Tunnell Productions
designer: [Randy Dersham, Jeff Tunnell]
...
The game exhibits compatibility issues when running on modern systems through emulation. The mouse driver (STDMOUSE.DRV) requires specific sound card configuration to function properly[^ref-9]. Users have discovered that the mouse functionality is unexpectedly linked to the Sound Blaster settings, requiring the soundblaster type to be set to "sb2" in DOSBox configuration for proper operation[^ref-9].

Sound card compatibility problems with Sound Blaster 16 and Pro Audio Spectrum cards were significant enough to warrant an official patch release[^ref-2].
...
| Various Characters | Emily Kokal |

Voice cast credited in full credits[^ref-2].
...
- [Internet Archive](https://archive.org/details/msdos_Mega_Math_1992) – Playable in browser
- [MyAbandonware](https://www.myabandonware.com/game/turbo-learning-mega-math-1gq) – Download and browser play available
