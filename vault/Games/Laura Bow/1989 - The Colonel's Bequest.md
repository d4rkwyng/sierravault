...
designer: [Roberta Williams, Bruce Balfour, Douglass Herring, Gerald Moore]
publisher: Sierra On-Line
genre: Adventure
platforms: [DOS, Amiga, Atari ST, Apple II, Apple IIgs]
series: Laura Bow
engine: SCI0
...
description: 'The Colonel''s Bequest: A Laura Bow Mystery stands as one of Sierra
  ...
  the...'
tags: [1980s, adventure, laura-bow, roberta-williams, sci, sierra]
---
...
The Colonel's Bequest: A Laura Bow Mystery stands as one of Sierra On-Line's most innovative and atmospheric adventure games, released in 1989 under the creative direction of Roberta Williams[^ref-1]. Set in 1925, this murder mystery adventure follows journalism student Laura Bow as she visits a remote Louisiana mansion where a family gathering turns deadly[^ref-2]. Unlike traditional Sierra adventures focused on puzzle-solving, The Colonel's Bequest pioneered an "interactive story" approach where players observe unfolding events rather than actively solving them[^ref-3].

The game was groundbreaking for its real-time progression system, where events occurred whether the player witnessed them or not[^ref-4]. As Williams explained in a contemporary interview, "There is no real goal - you're an innocent thrust into a situation where suddenly all these people are dying and things are happening"[^ref-5]. This experimental design created what many consider the first successful computer adaptation of the classic Agatha Christie murder mystery format[^ref-6].

> [!info]- Game Info
> **Developer:** [[Sierra On-Line]][^ref-1]
> **Design/Writing:** [[Roberta Williams]][^ref-5]
> **Publisher:** Sierra On-Line[^ref-1]
> **Platforms:** DOS, Amiga, Atari ST, Apple II, Apple IIgs[^ref-7]
> **Release Year:** 1989
> **Series:** Laura Bow
...
The game opens in the spring of 1925 during "a dark and stormy night"[^ref-9] as young Laura Bow, a journalism student at Tulane University in New Orleans[^ref-10], accompanies her friend Lillian to visit Colonel Henri Dijon's isolated plantation mansion deep in the Louisiana bayous[^ref-11]. The Colonel has mysteriously summoned his feuding relatives together to announce his intention to divide his fortune among them[^ref-12]. However, what begins as a family reunion quickly transforms into a deadly game as family members begin dying one by one under suspicious circumstances[^ref-13].

Laura finds herself thrust into the role of reluctant detective, armed only with her notepad and keen observational skills[^ref-14]. The mansion's inhabitants include a colorful cast of potential victims and suspects: the flapper Lillian, her mother Gertrude, the dapper Wilbur, the mysterious Jeeves the butler, and various other family members, each harboring dark secrets and murderous intentions[^ref-15]. As the night progresses, Laura must carefully observe the interactions between characters, eavesdrop on conversations, and piece together clues to understand the complex web of motives driving the killings[^ref-16].

The story unfolds across eight acts, with each death triggering progression to the next chapter[^ref-17]. Players can discover multiple possible endings depending on how much of the mystery they uncover and whether they successfully identify the true culprit behind the murders[^ref-18].
...
The visual presentation features 16-color EGA graphics that many players and critics praised for their atmospheric quality despite technical limitations[^ref-22]. Background artwork by Douglas Herring and Gerald Moore received particular acclaim for creating an authentic 1920s Southern Gothic atmosphere[^ref-20]. The game also included limited voice acting, which was considered a significant technical achievement at the time of release[^ref-23].

### Structure and Progression

Rather than following traditional adventure game structure, The Colonel's Bequest operates as "a PLAY divided into 8 'acts'"[^ref-17] with events progressing in real-time whether the player witnesses them or not[^ref-24]. This innovative approach meant that players could miss crucial story elements by being in the wrong location at the wrong time, significantly increasing replay value[^ref-25]. As developer Josh Mandel explained, "It gave the game a better sense of realism, that you could be in one place and miss something that was going on in another place"[^ref-26].

The game abandons traditional adventure game scoring in favor of a unique "Sleuth-O-Meter" system that rates players' detective abilities based on how many clues they discover and story elements they witness[^ref-24]. Players are evaluated at the game's conclusion through a series of questions about the events they observed, with their answers determining their final rating from "Klutz" to "Super Sleuth"[^ref-27]. This system was experimental for Sierra, as company documentation noted: "We hope this product will help bridge the gap and take gamers away from the cushion of needing a score to see how well they do"[^ref-24].
...
The Colonel's Bequest received generally positive reviews from gaming publications, though scores varied significantly across different platforms and regions. The game achieved particularly strong reception in French gaming magazines, with Génération 4 awarding it an exceptional 95% score[^ref-32]. Other notable contemporary scores included 92% from Joystick magazine[^ref-32], 89% from The Games Machine[^ref-2], and 88% from AUI[^ref-33].

| Publication | Score | Notes |
|-------------|-------|-------|
| Génération 4 | 95% | February 1990[^ref-32] |
| Joystick | 92% | March 1990[^ref-32] |
| The Games Machine | 89% | April 1990[^ref-2] |
| AUI | 88% | June 1991[^ref-33] |
| Zero | 85% | October 1990[^ref-32] |
| CU Amiga | 84% | September 1990[^ref-34] |
| Computer + Video Games | 83% | May 1990[^ref-32] |
| The One | 80% | March 1990[^ref-2] |
| Zzap!64 | 79% | October 1990[^ref-34] |

Critics praised the game's atmospheric presentation and innovative storytelling approach while noting some pacing issues. Computer Gaming World's Johnny L. Wilson described it as a "forerunner of one style of future entertainment software" while acknowledging it might not appeal to "hard-core adventure gamers"[^ref-2]. Games International's Theo Clarke gave it 8 out of 10, calling it "solid genre stuff" and noting "I have found all of the Sierra games quite obsessive but The Colonel's Bequest has a charm all of its own"[^ref-2].

### Modern Assessment

Retrospective reviews have been consistently positive, with many critics recognizing the game's historical significance and innovative design. Adventure Gamers awarded it 4 stars out of 5 in their 2003 retrospective, with Johann Walter calling it a "rather unique game [and] excellent game" and praising Williams as showing "that she was a master game designer, writing one of the very few good detective games in this mold"[^ref-35]. The game currently maintains strong user ratings across digital platforms, including 4.3/5 stars from GOG.com users[^ref-36] and 4.55/5 from MyAbandonware community votes[^ref-25].

Modern gaming analysts have highlighted the game's influence on interactive storytelling. PC Gamer's retrospective noted that "Laura Bow has never been as famous as King's Quest, but these two games were genuinely groundbreaking"[^ref-26]. The game's atmospheric qualities continue to resonate with players, with one GOG reviewer noting: "Between the Spanish moss and the secret passages and the crocodiles and the flapper dresses and the stranglings, I have a visceral memory of the game"[^ref-36].

## Development

### Origins

The Colonel's Bequest emerged from Roberta Williams' desire to return to her mystery game roots while utilizing the advanced computer capabilities of the late 1980s[^ref-9]. Williams had previously created Mystery House in 1980, widely considered the first graphical adventure game, and felt ready to tackle another murder mystery with improved technology[^ref-37]. As she explained in a 1990 START Magazine interview, the game represented a deliberate departure from traditional adventure game design: "Colonel's Bequest is very much an interactive story. One of the directions Ken and I see Sierra going is in interactive entertainment - stories"[^ref-5].

The development team was deliberately kept small to maintain creative focus, with Williams serving as primary designer while Bruce Balfour contributed to puzzle design and story elements[^ref-26]. The game's Southern Gothic atmosphere was carefully researched, with particular attention paid to 1920s period details and Louisiana bayou settings[^ref-38]. Williams drew inspiration from classic mystery novels, particularly the works of Agatha Christie, as well as horror films and Southern Gothic literature[^ref-4].

### Production

The game utilized Sierra's newly developed SCI engine, representing one of the early showcases for the technology that would power most of Sierra's subsequent adventure games[^ref-20]. Art direction by Douglas Herring and Gerald Moore focused on creating atmospheric 16-color backgrounds that maximized the visual impact within technical constraints[^ref-20]. Ken Allen composed the original music, including the memorable title theme that has since been covered by independent musicians[^ref-39].

Voice acting was implemented selectively, featuring Sierra staff members including Jane Jensen (later designer of Gabriel Knight) as "a lewd flapper," Josh Mandel in five different roles, and Scott Murphy in an unspecified part[^ref-40]. The limited voice work was considered cutting-edge for 1989, when "full speech in adventure games was a relatively rare occurrence at the time of its release, and was regarded as a big selling point"[^ref-23].

Marketing materials included innovative packaging with a red-tinted "monocle" that players could use to decode hidden messages in the manual, reflecting the game's detective theme[^ref-25]. Sierra's promotional video catalogs of the late 1980s featured The Colonel's Bequest prominently among their adventure game lineup[^ref-41].

### Technical Achievements

The real-time event system represented the game's most significant technical innovation, requiring careful programming to ensure story events triggered properly regardless of player location[^ref-42]. The development team had to balance giving players freedom to explore while ensuring they could still experience the core narrative elements[^ref-16]. This system influenced later adventure games and helped establish conventions for non-linear storytelling in interactive media[^ref-43].

The game also featured hidden content accessible only through script decompilation, including a rare easter egg with a 1-in-200 chance of triggering when entering specific locations[^ref-44]. Technical analysis has revealed unused graphics, including airplane sprites that were programmed but never displayed in normal gameplay[^ref-44]. These hidden elements demonstrate the experimental nature of the development process and the team's attention to atmospheric detail[^ref-45].

A 1993 reissue corrected various technical issues, including improved firefly effects in the opening boat sequence and better movement patterns for atmospheric elements[^ref-46]. The game has since been preserved through multiple digital distribution platforms and remains fully playable through modern emulation[^ref-47].

### Version History

| Version | Date | Platform | Notes |
|---------|------|----------|-------|
| 1.0 | September 1989 | DOS | Initial release with SCI0.1 engine[^ref-55] |
| 1.0 | 1989 | Amiga, Atari ST | Console ports with similar features |
| 1.1 | 1993 | DOS | Reissue with improved firefly effects[^ref-46] |

The game supports multiple audio standards including AdLib, Sound Blaster, and Roland MT-32[^ref-55]. Modern players can access walkthroughs and detailed Act-by-Act guides[^ref-56][^ref-57] to fully experience the game's complex narrative structure.

## Legacy

The Colonel's Bequest established the Laura Bow franchise and demonstrated the viability of story-driven adventure games focused on atmosphere over puzzle complexity[^ref-3]. Its influence can be seen in later detective games and interactive fiction that prioritize observation and narrative discovery[^ref-48]. The game's success led to a direct sequel, The Dagger of Amon Ra, in 1992, with Bruce Balfour handling writing and puzzle design while Williams maintained creative oversight[^ref-49].
...
|  | **Laura Bow Series** |  |
|:---:|:---:|:---:|
| **←** First game in series | [[1992 - The Dagger of Amon Ra\|The Dagger of Amon Ra]] | **→** |

The Colonel's Bequest established Laura Bow as Sierra's mystery-solving heroine. The sequel, [[1992 - The Dagger of Amon Ra|The Dagger of Amon Ra]], follows Laura's adventures in New York City as a journalist investigating a murder at a museum.

## Downloads

**Purchase / Digital Stores**
- [GOG.com](https://www.gog.com/en/game/the_colonels_bequest)[^ref-36]
...
[^ref-29]: [The Spoiler](https://the-spoiler.com/ADVENTURE/Sierra/colonels.bequest.3.html) – - Detective gameplay walkthrough
[^ref-30]: [Reddit Discussion](https://www.reddit.com/r/Sierra/comments/1natvkl/the_colonels_bequest_featuring_laura_bow_1989/) – - Psycho shower scene reference
[^ref-31]: [Choice Games Review](https://www.choicestgames.com/2020/06/the-colonels-bequest-review.html) – - Death avoidance strategy analysis
[^ref-32]: [AMR Archive Reviews](https://amr.abime.net/review_30401) – - Génération 4 score and date
[^ref-33]: [AMR Archive Database](https://amr.abime.net/review_5364) – - AUI magazine score
[^ref-34]: [Web Archive Amiga Reviews](https://web.archive.org/web/20071223012716/http://amigareviews.classicgaming.gamespy.com/colonels.htm) – - CU Amiga detailed score breakdown
[^ref-35]: [Web Archive Adventure Gamers](https://web.archive.org/web/20131004232247/http://www.adventuregamers.com/articles/view/17513) – - Johann Walter retrospective review
[^ref-36]: [GOG.com](https://www.gog.com/en/game/the_colonels_bequest) – - User review scores and store page
[^ref-37]: [Grok Encyclopedia](https://grokipedia.com/page/The_Colonel%27s_Bequest) – - Mystery House connection and development history
[^ref-38]: [Rock Paper Shotgun](https://www.rockpapershotgun.com/the-colonels-bequest) – - Atmospheric research and design
[^ref-39]: [Bandcamp Music](https://richdouglasmusic.bandcamp.com/album/the-colonels-bequest-single) – - Ken Allen composer confirmation
[^ref-40]: [MobyGames Credits](https://www.mobygames.com/game/461/the-colonels-bequest/credits/dos/) – - Voice cast information
[^ref-41]: [Sierra Gamers](https://www.sierragamers.com/video-catalogs/) – - Promotional video catalog mention
[^ref-42]: [TV Tropes](https://tvtropes.org/pmwiki/pmwiki.php/VideoGame/LauraBow) – - Technical programming challenges
...
[^ref-50]: [Steam - Laura Bow and the Mechanical Codex](https://store.steampowered.com/app/2549910/Laura_Bow_and_the_Mechanical_Codex/) – - Upcoming sequel announcement
