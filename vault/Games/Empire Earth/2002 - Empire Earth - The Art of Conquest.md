...
Reception for The Art of Conquest was decidedly mixed, with critics divided on whether the expansion justified its $30 price tag. GameZone gave the expansion a highly favorable 91/100, praising its additions: "It adds so many little things that it will be worth the players hard earned cash. The Space Epoch itself is worth the price of it."[^ref-15] GameSpy awarded it 88/100, noting it "provides a number of strong enhancements to a game that already offers immeasurably high replay value."[^ref-16]

IGN's Steve Butts gave the expansion 7.8/10, with breakdown scores of 8.0 for presentation, 7.5 for graphics, 7.0 for sound, 8.0 for gameplay, and 8.0 for lasting appeal.[^ref-6] However, he concluded that "I like Art of Conquest enough but it just falls short of being worth the $30 price tag. Rather than being a full-fledged expansion, this one seems like little more than a mission pack with a few extra novelties thrown in to sweeten the deal."[^ref-6]
...
|---------|------|----------|-------|
| 1.0 | September 17, 2002 | Windows | North American release[^ref-4] |
| 1.0 | October 4, 2002 | Windows | European release[^ref-1] |
| 1.0 | October 21, 2002 | Windows | Australian release[^ref-27] |
| 1.0 | February 28, 2003 | Windows | Japanese release (Capcom publisher)[^ref-28] |
| Gold Edition | May 6, 2003 | Windows | Bundled with original Empire Earth[^ref-1] |

**Community Patch Versions:**[^ref-24]
...
Note: The Art of Conquest never received an official patch from Mad Doc Software or Sierra Entertainment.[^ref-21]

### Technical Issues

The game was designed for Windows 98 and relies on components not well-supported on modern versions of Windows.[^ref-24] Known issues include:

- Crash on using Hardware T&L on certain modern graphics cards[^ref-21]
- Game freezes in main menu on Windows 10[^ref-21]
- Game stuck in 24Hz on HDMI monitors[^ref-21]
- Crashes after loading Asian mission 3 in Polish language version[^ref-21]
- Game freezes at resolutions 2560x1440 and above[^ref-21]
- Star map underlying space terrain doesn't shift with view, making scrolling confusing[^ref-6]
- Unit AI behaves erratically—cavalry units turn around during exploration[^ref-6]
- Path-finding issues with big, slow units, especially with rally points[^ref-6]
- Cutscenes can trigger during battle, leaving troops uncontrolled[^ref-6]
- Unit acknowledgements echo with delays when selecting large groups[^ref-6]
- Script bug in Roman campaign allows player to destroy pyramid without being defeated[^ref-1]
- Multiplayer has many exploits giving unfair advantages[^ref-1]
- Intel HD Graphics compatibility issues[^ref-24]
- Minimap partially white with AMD graphics cards[^ref-24]
...
- The official forums featured a Latin anti-cheating warning: "O cheaters, if you do not mend your ways, know that you will suffer a dreadful fate."[^ref-30]
...
The base game Empire Earth sold more than 1 million copies worldwide according to Sierra, establishing a strong foundation for the expansion.[^ref-4] The Art of Conquest sold 50,000 units in France alone by March 2005.[^ref-1] The expansion retailed at a suggested price of $29.99 USD, which many reviewers considered steep for the amount of content provided.[^ref-4]

### Awards

The original Empire Earth received significant recognition which helped promote the expansion:
- PC Game of the Year from GameSpy.com[^ref-2]
- Gold Award from PC Action magazine (Germany)[^ref-2]
- Trophy Award for special achievement in gaming from PC Team magazine (France)[^ref-2]

### Collections

- **Empire Earth Gold Edition** (May 6, 2003) - Included both the original Empire Earth and The Art of Conquest expansion[^ref-1]
- **Empire Earth: Platinum Edition** (Europe) - Alternative regional naming[^ref-26]
- **Empire Earth: Complete** (Japan) - Japanese market release[^ref-26]

The game is currently available digitally through GOG.com as part of the Empire Earth Gold Edition package.[^ref-31]

### Server Shutdown

Sierra announced that matchmaking services for Empire Earth and The Art of Conquest would be taken offline on November 1, 2008, as part of a shutdown affecting 21 Sierra titles.[^ref-32] WON servers officially shut down at 7pm GMT on November 3, 2008.[^ref-1] As Blake Ellison reported: "Online multiplayer in games will still be playable but players will have to use direct IP connections to servers or use third-party server browsing software."[^ref-32]
...
- **Empire Earth: The Art of Conquest Prima's Official Strategy Guide** - Written by IMGS, Inc., Melissa Tyler, Tuesday Frase, and Prima Temp Authors Staff. Published by Prima Games, October 1, 2002. 240 pages. ISBN: 0-7615-3981-6[^ref-35]
  ...
  - Civilization pros and cons with details on new civilization powers[^ref-35]
...
- [Internet Archive - Prima Official Strategy Guide](https://archive.org/details/Empire_Earth_Empire_Earth_The_Art_of_Conquest_Prima_Official_eGuide)
