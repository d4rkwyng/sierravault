...
designer: [John Cutter, Neal Hallford, Peter Sarrett]
publisher: Sierra On-Line
genre: RPG
platforms: [Windows, PC, Windows 95, Windows 3.1, Windows for Workgroups]
...
description: Betrayal in Antara is a 1997 role-playing game developed and published
  ...
  at...
tags: [1990s, krondor-series, rpg, sierra]
---
# Betrayal in Antara
...
Betrayal in Antara is a 1997 role-playing game developed and published by Sierra On-Line as a spiritual successor to the acclaimed 1993 title Betrayal at Krondor[^ref-1]. While utilizing an updated version of Betrayal at Krondor's game engine, the game takes place in an entirely new fantasy world called Ramar rather than Raymond E. Feist's Midkemia universe[^ref-2]. As author Raymond E. Feist himself clarified, "Betrayal in Antara by Sierra is a 'sequel' to BaK only insofar as it's using the same general game engine and is created by the company that owned Dynamix. Other than that it has nothing to do with my work"[^ref-3].

The game emerged from Sierra's need to create a new RPG after losing the rights to produce another game based on Raymond Feist's The Riftwar Cycle[^ref-4]. Designer Peter Sarrett became involved with the project in an unusual way, after CEO Ken Williams discovered him playing extended sessions of Betrayal at Krondor during work hours and summoned him with the message "Come see me in my office"[^ref-5]. Sierra positioned the game as their return to role-playing games, with PC Gamer announcing in 1997 that "Sierra On-Line has begun shipping Betrayal in Antara, a follow-up to their award-winning roleplaying game Betrayal at Krondor"[^ref-6].
...
Set in the Empire of Antara in the fantasy world of Ramar, players take on the role of Aren and his companions William as they become embroiled in a conspiracy involving a dying man named Gregor who presses a medallion into William's hand while speaking his last word: "Consort"[^ref-8]. The story unfolds across nine chapters as players work to "save the empire of Antara from corruption and war"[^ref-9]. Unlike its predecessor, the game does not continue Raymond E. Feist's Riftwar saga but instead starts a new tale in a different fantasy world[^ref-2].

The narrative explores themes of political intrigue and betrayal as the protagonists navigate the crumbling Antaran Empire. The game features 34 interactive characters throughout the adventure[^ref-10], with players seeking "power, fortune and glory" while uncovering the larger conspiracy threatening the realm[^ref-10].

## Gameplay

### Interface and Controls

Designer Peter Sarrett made a conscious decision to maintain familiarity with the predecessor, stating "I decided early on not to fix what wasn't broken, and BAK players will find the interface and combat system of Betrayal in Antara familiar"[^ref-5]. The game requires a 2-button PC compatible mouse for navigation[^ref-5] and features both first-person exploration and third-person turn-based combat on a hexagonal grid[^ref-11].

Unlike Betrayal at Krondor, most towns in Antara can be physically explored rather than accessed through menu screens[^ref-2]. The game also offers an optional full-screen view that was not available in its predecessor[^ref-2]. Players navigate through day/night cycles with light level simulation affecting gameplay[^ref-11].

### Structure and Progression

The game employs a skill-based progression system without traditional experience points or levels[^ref-12]. Spells are cast using health and stamina points instead of a separate magic point system[^ref-12]. Character Arren is the only party member capable of casting magic, and players can increase his magic stat by sleeping at his home in Briara[^ref-13].

Gameplay tips from community guides suggest that "Scouting is most important for the other guy and gals...combine its with stealth...it will virtually negate any ambush by enemy"[^ref-13]. The game includes a food system and features puzzle-lock chests throughout the adventure[^ref-11].

### Puzzles and Mechanics

The game includes various cheat codes that reference popular culture, including Douglas Adams' Hitchhiker's Guide to the Galaxy. Players can enter "Ask a glass of water" to teleport to the start of a chapter, "Why am I so dull" to learn skills faster, or "Some call me tim" to kill all opponents in combat[^ref-14]. These references earned the game a 7.3/10 rating from users on the Easter egg database[^ref-14].

Combat maintains the turn-based tactical approach of its predecessor, with battles playing out on hexagonal grids. The game features both battle themes and location-specific music, including tavern songs and "The Ballad Of The Cyrilan" musical sequence[^ref-15].

## Reception

### Contemporary Reviews

Betrayal in Antara received mixed reviews from critics, with many praising the gameplay while criticizing technical aspects. The game achieved a Metacritic user score of 7.4/10 based on 7 user ratings[^ref-16].

| Publication | Score | Notes |
|-------------|-------|-------|
| GameSpot | 6.6/10 (Fair) | Criticized graphics quality and linearity[^ref-17] |
| Next Generation | 3/5 stars | Compared favorably to Doom II sequel approach[^ref-1] |
| MobyGames Critics | 68% average | Mixed professional reception[^ref-18] |
| IMDb | 6.9/10 | User rating[^ref-19] |
| OldGames.sk | 68% | Community rating[^ref-20] |

GameSpot's reviewer Desslock noted that "For gamers willing to tolerate substandard graphics and linear gameplay, Betrayal in Antara succeeds in providing an enjoyable role-playing experience"[^ref-17]. However, he criticized the visuals severely, stating the graphics are "frankly, as ugly as an orc" and describing the color palette as "muddy Monet"[^ref-17].

### Modern Assessment

Player reviews on MobyGames and other platforms reflect a divided opinion. One reviewer noted that "The game doesn't make a good impression graphically from the word go" and criticized the voice acting as "Very bad"[^ref-18]. However, another player defended the game, writing "This is a great game and deserves great reviews. It's not fair to mark it down for not playing on newer systems"[^ref-10].

Community discussions on forums like RPG Codex acknowledge that while "Game's not as good as BaK but worth playing"[^ref-21], it still provides entertainment for fans of the original. Technical issues have been a persistent complaint, with users reporting crashes during chapter transitions and compatibility problems on modern systems[^ref-22].

## Development

### Origins

The development of Betrayal in Antara arose from Sierra's desire to capitalize on the success of Betrayal at Krondor while navigating licensing constraints. As gaming historian Jimmy Maher noted, the game "copied some of the interface elements and gameplay approaches of its predecessor, but moved the action to a generic fantasy world, to less satisfying effect"[^ref-4]. Sierra had lost the rights to produce another game based on Raymond Feist's Midkemia, requiring them to create the new world of Ramar[^ref-4].

Peter Sarrett's involvement as designer began unconventionally when he was discovered playing Betrayal at Krondor during work hours. He recalled: "Loading it up at lunch time, I'd wind up playing well into the afternoon before I realized the time had passed. Many evenings I stayed at work past midnight hacking my way through just one more group of enemies"[^ref-5].

### Production

The development team included lead programmer Rikki Cleland-Hura, who helped flesh out world details, while the art team created the visual look for the Antaran Empire setting[^ref-5]. The game utilized composers David Henry and Jan Paul Moorhead for the musical score[^ref-23], creating 72 audio files totaling 1 hour and 25 minutes of music[^ref-15].

Sierra released the game on three CD-ROMs with a total installation size of 926.9 MB[^ref-2]. The technical requirements included a 486DX4/100 or faster processor, 16 MB RAM, 4X CD-ROM drive, sound card, and mouse[^ref-11]. The game used textured 3D graphics with sprites and was compiled using Borland C++ with Ergo DPMI/RTM DOS extender[^ref-11].

### Technical Achievements

One of the notable aspects was that Betrayal in Antara was "one of the first RPGs to utilize high-resolution SVGA graphics"[^ref-1], though this technical advancement was not well-received by critics. The development team took photos of different landscapes and touched them up with 3D tools to create a painted appearance[^ref-4].

A significant patch (version 1.10) was released to address "the problem some users have had when loading chapters, as well as a few other issues"[^ref-24]. The patch files are preserved in archives, including Sierra update files that fix chapter 9 bugs and other crashes[^ref-25]. Multiple review sites[^ref-29][^ref-30] and comprehensive walkthroughs[^ref-31] documented the game's content.

### Version History

| Version | Date | Platform | Notes |
|---------|------|----------|-------|
| 1.0 | 1997 | Windows | Initial release |
| 1.10 | 1997 | Windows | Chapter loading fix patch[^ref-24] |
...
|  | **Krondor Series** |  |
|:---:|:---:|:---:|
| **←** [[1993 - Betrayal at Krondor\|Betrayal at Krondor]] | [[1998 - Return to Krondor\|Return to Krondor]] | **→** |

While Betrayal in Antara uses the same engine as [[1993 - Betrayal at Krondor|Betrayal at Krondor]], it is set in an entirely different world and is not part of Raymond E. Feist's Riftwar Saga. The series proper continues with [[1998 - Return to Krondor|Return to Krondor]], which returned to the Midkemia setting.

## Downloads

**Purchase / Digital Stores**
- [GOG.com – Betrayal at Krondor Pack](https://www.gog.com/en/game/betrayal_at_krondor) - Includes Betrayal in Antara bundled with Betrayal at Krondor[^ref-28]
...
[^ref-6]: [Web Archive - PC Gamer News 1997](https://web.archive.org/web/19980218070614/http://www.pcgamer.com/news/news-1997-06-30.html) – - Contemporary shipping announcement
[^ref-7]: [MobyGames - Betrayal in Antara](https://www.mobygames.com/game/695/betrayal-in-antara/) – - Credits and technical specifications
[^ref-8]: [TV Tropes - Betrayal in Antara](https://tvtropes.org/pmwiki/pmwiki.php/VideoGame/BetrayalinAntara) – - Story details and character dialogue
[^ref-9]: [Sierra Gamers - Betrayal in Antara](https://www.sierragamers.com/betrayal-in-antara/) – - Game plot description
