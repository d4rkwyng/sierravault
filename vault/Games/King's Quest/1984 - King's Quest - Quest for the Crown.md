...
publisher: IBM (PCjr), Sierra On-Line
genre: Adventure
platforms: [IBM PCjr, IBM PC, Tandy 1000, Apple II, Apple IIGS, DOS, Amiga, Atari
    ST, Mac, Sega Master System]
series: King's Quest
engine: AGI
...
> **Publisher:** IBM (PCjr), Sierra On-Line[^ref-3]
> **Engine:** AGI (Adventure Game Interpreter)[^ref-7]
> **Platforms:** IBM PCjr, IBM PC, Tandy 1000, Apple II, Apple IIGS, MS-DOS, Amiga, Atari ST, Macintosh, Sega Master System[^ref-8]
...
King's Quest employs a hybrid interface combining keyboard-controlled character movement with text parser commands for actions[^ref-4]. Players use arrow keys or joystick to guide Sir Graham around each scene in real time, positioning him near objects or characters before typing commands such as "look tree," "open door," or "talk man"[^ref-4][^ref-12]. This represented a significant departure from earlier text adventures and illustrated adventure games, where interaction was purely text-based.

The game pioneered animated interaction between the player's avatar and the environment. Graham could walk behind trees, in front of rocks, swim across lakes, climb ladders, and enter buildings—all rendered with smooth animation. COMPUTE! magazine observed: "The three-dimensional quality makes it seem like Sir Grahame is moving through an animated cartoon"[^ref-14]. Roberta Williams recalled: "People were amazed you could walk around these detailed screens, behind trees and in front of rocks"[^ref-10].

### Structure and Progression

The game world comprises 80 total scenes: 48 outdoor locations arranged in a 6x8 wraparound grid, plus 32 interior scenes for caves, houses, and other enclosed spaces[^ref-14][^ref-15]. The outdoor world wraps continuously in all directions, meaning Graham can travel indefinitely and eventually return to his starting point[^ref-9].

Players pursue the three treasures in any order, with multiple valid paths through the game[^ref-4]. A scoring system awards up to 158 points, with higher scores achieved through discovering alternate solutions and avoiding unnecessary violence[^ref-16]. Non-lethal approaches to obstacles consistently reward more points than violent solutions—killing the dragon with a dagger works, but dousing its flame with water and sending it away embarrassed earns more points[^ref-11].
...
The protagonist was originally named "Sir Grahame" in early versions[^ref-3].

Roberta Williams drew inspiration from her love of fairy tales: "So IBM wanted a new type of game to show off its new computer. I was thinking about a fairytale adventure with lost treasures, giants, dragons, leprechauns, a gingerbread house, a troll bridge, guessing a gnome's name. Underground and sky castles were always popular stories, so I had to find ways to include them too"[^ref-10].

### Technical Achievements

The team developed the Adventure Game Interpreter (AGI), originally called the "Game Adaptation Language" (GAL)[^ref-3]. Ken Williams reportedly "loathed the cutesiness of GAL acronym" and renamed it[^ref-3]. This interpreter-based architecture allowed the same game logic to run on different hardware—a technique that proved vital when the PCjr failed commercially[^ref-7].

Graphics were created by tracing hand-drawn artwork on a graphics tablet, storing scenes as vector instructions rather than bitmap images[^ref-14]. This compression technique kept room data between 470 and 2,400 bytes per scene[^ref-14]. The opening Castle Daventry scene, the game's most complex, required 2,400 bytes and approximately four seconds to render[^ref-14]. Williams explained: "Limited floppy space would have restricted my design, but we had been compressing our pictures by drawing them as lines and fill colors for a while. That scheme was kept all the way up to King's Quest V"[^ref-10].
...
- **CPU:** 8088 or 8086 compatible[^ref-39]
- **RAM:** 128KB (booter versions); 256KB (DOS versions from 1986+)[^ref-39]
- **DOS:** Version 2.0 or later (DOS versions only)[^ref-39]
- **Graphics:** CGA Composite, CGA RGB, EGA, Hercules, MCGA, Tandy 16-color[^ref-39]
- **Resolution:** 160×200 pixels in 16 colors[^ref-39]
- **Audio:** PC speaker or PCjr/Tandy 3-voice sound[^ref-39]
- **Input:** Keyboard, joystick optional[^ref-8]

### Version History

King's Quest has more distinct releases than any other AGI game—eight versions spanning 1984-1987[^ref-39].

| Version | Date | Platform | AGI | Notes |
|---------|------|----------|-----|-------|
| 1.0 | May 10, 1984 | IBM PCjr | v1 | First release, 128KB, non-standard sector protection[^ref-39] |
| PC 1.0 | May 30, 1984 | IBM PC | v1 | Composite CGA only, Formaster Copylock, "Grahame" → "Graham"[^ref-39] |
...
- Apple IIGS (April 1988)[^ref-30]
- Sega Master System (July 1989)[^ref-19]

### Version Differences

**Apple II:** The parser occupies screen space where alligators would appear in other versions, so alligators were removed from the moat. The Sierra logo, text parser, and inventory screens appear in white instead of color[^ref-31].

**Apple IIGS (1988):** Ported by Juan Carlos Escobar and Al Lowe, this version features extensive audio enhancements[^ref-30]:
...
The game's influence extended beyond Sierra's own franchises. Homestar Runner's "Peasant's Quest" (2004) parodied King's Quest with EGA-style graphics and text parser gameplay, featuring protagonist Rather Dashing in a deliberate homage to Sir Graham[^ref-8].
...
**Easter Eggs:**
- **Knight Rider Reference:** Guessing "Mikel Knight" at the gnome puzzle references the TV show Knight Rider; the name also appears in the game credits[^ref-29]
- **Troll Bridge Messages:** Typing "beg troll" while the troll guards a bridge yields special messages that differ for each bridge. The east bridge has a rare spelling error: "Trool"[^ref-29]
- **Debug Mode:** Pressing Alt+D enables debug commands[^ref-29]

**Trivia:**
- **Daventry Flag:** The flag visible in the castle throne room is the flag of Sierra Leone rotated vertically—a pun on "Sierra On-Line"[^ref-8]
- **Graham's Name:** Sir Graham was named after Roberta Williams' fondness for graham crackers[^ref-8]
- **IBM Box Error:** The original IBM packaging featured incorrect descriptions and artwork because the ad copy was written before the game was completed[^ref-8]
...
- **Cut Goat/Witch Messages:** Unused text includes "The goat is suspicious of this witch's house and refuses to go in" and "With the goat now dead, you are fair game for the witch"[^ref-42].
- **PCjr-Only Feature:** In the original PCjr version, players can bow to the dead king and receive the message: "You bow, but you are the only one who knows it"[^ref-42].

### Collections

This game has been included in[^ref-8][^ref-9]:
...
- [GOG.com – King's Quest 1+2+3](https://www.gog.com/en/game/kings_quest_1_2_3) – Includes 1987 AGI version and 1990 SCI remake[^ref-23]
...
- [The King's Quest Companion](https://archive.org/details/kingsquestcompan00spea) – Peter Spear hint book[^ref-37]
- [Sierra Chest – King's Quest I](https://www.sierrachest.com/index.php?a=games&id=1) – Walkthrough, maps, memorabilia[^ref-9]
- [Sierra Help – KQ1 AGI](https://sierrahelp.com/Games/KingsQuest/KQ1AGIHelp.html) – Patches, saves, technical support
- [Sierra Help – KQ1 SCI Remake](https://sierrahelp.com/Games/KingsQuest/KQ1SCIHelp.html) – Patches, saves, technical support
- [Sierra Help – KQ1 AGI Point List](https://sierrahelp.com/Misc/PointLists/KQ1AGIPoints.html) – Complete scoring guide[^ref-16]
...
[^ref-2]: [Wikipedia – King's Quest I](https://en.wikipedia.org/wiki/King%27s_Quest_I) – – Encyclopedia article, platform releases
[^ref-3]: [The Digital Antiquarian – The Unmaking and Remaking of Sierra On-Line](http://www.filfre.net/2013/07/the-unmaking-and-remaking-of-sierra-on-line/) – – IBM commission, napkin pitch, AGI development, $850K cost, Project Siesta codename
[^ref-4]: [COMPUTE! Magazine – February 1985, pg 136](https://archive.org/details/1985-02-compute-magazine/page/n137) – – Donald B. Trivette "Inside King's Quest": hybrid interface, multiple solutions
[^ref-5]: [Telltale Games Forum Archive – Electronic Games Magazine 1984](https://community.telltalegames.com/discussion/30268/) – – "major breakthrough" review quote, "blows everything away"
[^ref-6]: [IEEE Spectrum – Meet Roberta Williams](https://spectrum.ieee.org/meet-roberta-williams-the-queen-of-graphic-adventure-video-games) – – "first animated 3D adventure game"
[^ref-7]: [ScummVM Wiki – AGI](https://wiki.scummvm.org/index.php/AGI) – – Adventure Game Interpreter engine details
[^ref-8]: [MobyGames – King's Quest](https://www.mobygames.com/game/122/kings-quest/) – – Credits, platforms, trivia, graham crackers naming, Avis Durgan encryption, Sierra Leone flag
[^ref-9]: [Sierra Chest – King's Quest I](https://www.sierrachest.com/index.php?a=games&id=1) – – Plot, collections, world looping
[^ref-10]: [Adventure Classic Gaming – King's Quest](https://www.adventureclassicgaming.com/index.php/site/reviews/120/) – – 5/5 review, Roberta Williams quotes on design, gnome puzzle acknowledgment, vector graphics
[^ref-11]: [TV Tropes – King's Quest I](https://tvtropes.org/pmwiki/pmwiki.php/VideoGame/KingsQuestIQuestForTheCrown) – – Fairy tales, gnome cipher, pacifist scoring, random encounters
[^ref-12]: [TechnologyUK – King's Quest](https://www.technologyuk.net/computing/computer-gaming/gaming-landmarks-1960-1985/kings-quest.shtml) – – Hybrid controls, gnome puzzle hint
[^ref-13]: [Choicest Games Review – King's Quest I](https://www.choicestgames.com/2016/04/kings-quest-i-1987-review.html) – – "animated cartoon" description
[^ref-14]: [COMPUTE! Feb 1985 / KQ Omnipedia](https://kingsquest.fandom.com/wiki/Inside_King%27s_Quest) – – 80 scenes (48+32), vector graphics, priority system, room data sizes, collision detection
[^ref-15]: [Sierra Newsletter – Winter 1988](https://www.mocagh.org/sierra/sierranews-winter88.pdf) – – 80 rooms in KQ1, 800,000+ series sales by 1988
...
[^ref-21]: [Adventure Gamers – King's Quest](https://adventuregamers.com/games/kings-quest-quest-for-the-crown) – – #10 Top 20 All-Time, 3/5 review, 1990 remake features
...
[^ref-25]: [HowLongToBeat – King's Quest](https://howlongtobeat.com/game/5036) – – 2½ hours average completion
