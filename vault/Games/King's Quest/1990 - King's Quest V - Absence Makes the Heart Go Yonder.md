...
genre: Adventure
platforms: [DOS, Windows, Amiga, Mac, NES, FM Towns, PC-98]
series: King's Quest
engine: SCI1
...
On a beautiful sunny day, King Graham of Daventry decides to take a stroll in the woods surrounding his castle. When he returns, he discovers with horror that his home, Daventry Castle, has completely disappeared along with his entire family.[^ref-2] Graham is at a loss, wondering how this could have happened, when a talking owl named Cedric appears and tells him that he witnessed the whole event—an evil wizard named Mordack used a powerful spell to whisk the entire castle away.[^ref-2]

Cedric transports Graham to the land of Serenia to meet his master, the good wizard Crispin, who provides Graham with his old wand and grants him the ability to speak with animals.[^ref-10] The adventure takes Graham through diverse locations including a dark forest, a scorching desert, treacherous mountains, and ultimately to Mordack's foreboding island castle.[^ref-11] Along the way, Graham must solve puzzles, help those in need, and gather the items necessary to confront the evil wizard.

The villain Mordack is revealed to be the brother of Manannan, the evil wizard from King's Quest III whom Prince Alexander had transformed into a cat.[^ref-6] Mordack seeks revenge against Alexander for his sibling's downfall, and has imprisoned the royal family with the intention of feeding them to Manannan.[^ref-12] Graham must navigate through Mordack's castle, rescue Princess Cassima (who would become central to the next game's plot), and ultimately defeat the wizard in a magical duel to save his family and restore Daventry Castle to its rightful place.[^ref-13]

## Gameplay

### Interface and Controls

King's Quest V introduced a completely new icon-driven interface that requires no typing on the keyboard, representing Sierra's first fully point-and-click adventure game.[^ref-14] The game uses simplified action commands through cursor icons including Walk, Eye (look), Hand (interact), and Head (talk), which players can cycle through to interact with the game world.[^ref-2] This marked a dramatic departure from the text parser interface used in all previous King's Quest games and fundamentally changed how players experienced Sierra adventures.[^ref-1]

The interface was designed to be more accessible to a broader audience, fitting Sierra's marketing push to "bring the family" into the world of King's Quest.[^ref-15] Players interact with the environment by selecting appropriate icons and clicking on objects, characters, or locations within the beautifully rendered scenes.[^ref-14] An inventory system allows players to collect and use items throughout the adventure, which is central to solving the game's many puzzles.
...
- **Serenia Forest and Town:** The starting area where Graham learns about his quest and gathers essential supplies from the town's various shops and inhabitants.[^ref-16]
- **The Dark Forest:** A dangerous woodland area featuring encounters with a witch, gnomes, and other fairy tale creatures.[^ref-16]
- **The Desert:** A challenging desert map that received significant criticism for its difficulty in navigation.[^ref-17]
- **The Mountain Pass:** Snowy peaks featuring encounters with an Ice Queen, a Yeti, and a memorable sled ride sequence.[^ref-18]
- **The Sea and Harpie Island:** Graham's ocean voyage and encounters with mythological creatures.[^ref-18]
- **Mordack's Castle:** The final dungeon where Graham must navigate treacherous corridors, rescue his family, and defeat the evil wizard.[^ref-13]

### Puzzles and Mechanics

The game features inventory-based puzzles typical of Sierra adventures, requiring players to collect items and use them in appropriate situations.[^ref-14] A scoring system tracks player progress, with a maximum of 260 points available throughout the game.[^ref-19] However, the game has been criticized for containing numerous dead-ends—situations where players can progress past a point of no return without necessary items, making the game unwinnable without reloading an earlier save.[^ref-1]

Players must frequently perform good deeds that are rewarded later in the game, embodying the fairy tale morality that defined the King's Quest series.[^ref-16] The game includes many ways to die, requiring players to save frequently.[^ref-20] Some puzzle solutions have been criticized as illogical or overly obtuse, such as the infamous requirement to throw a shoe at a cat to rescue a mouse.[^ref-21]

## Reception

### Contemporary Reviews

King's Quest V received widespread critical acclaim upon release. Scorpia of Computer Gaming World praised the game's "graphic tour-de-force" visuals, while the magazine's editors named it the 1991 Adventure Game of the Year.[^ref-5][^ref-6] Dragon magazine awarded the game 4 out of 5 stars in 1991.[^ref-6] The game earned the 1991 CODiE Award (Software Publishers Association Excellence in Software Award) for Best Fantasy Role Playing/Adventure Program.[^ref-3]

Critics universally praised the VGA graphics as revolutionary for their time.[^ref-17] However, the CD-ROM version's voice acting received more mixed reactions, with Charles Ardai of Computer Gaming World describing it as "wooden."[^ref-6] The desert navigation section was singled out for criticism by multiple reviewers.[^ref-17] MPC World readers voted it the Best Multimedia Fantasy/Adventure Game in 1992.[^ref-6]

### Modern Assessment

Modern retrospectives have been more critical of the game's design choices. Adventure Gamers rated the game 3 out of 5 stars, describing it as "a step forward in graphics and interface; a step backward in story and character development."[^ref-22] The review recommended that players "skip ahead to KQVI, which is so much better" unless they are dedicated King's Quest fans.[^ref-22]

Hardcore Gaming 101 noted that "despite its popularity at the time, [the game] has aged quite poorly."[^ref-8] GameCola's Nathaniel Hoover gave it a 5 (Average) rating, criticizing that "the gameplay ruins the game, but it's not even that the puzzles themselves are bad—it's the misleading or altogether absent communication about what is actually a puzzle."[^ref-23] The Adventurers' Guild blog rated the game 56/100 in their retrospective playthrough.[^ref-24]

**Aggregate Scores:**
- **IMDB:** 7.8/10[^ref-25]
- **Adventure Gamers:** 3/5 stars[^ref-22]
- **Choicest Games:** 7/10[^ref-17]
- **Adventure Classic Gaming:** 4/5 (Very Good)[^ref-1]
...
Sierra's creative director Bill Davis introduced new storyboarding methodologies borrowed from the film industry to manage the ambitious project. "We are going to take some of the techniques that have been used in the film industry to manage gigantic feature projects and apply them here," Davis explained.[^ref-15] Williams approached the design with the philosophy of creating a true adventure experience: "We didn't want to make it so you go here and solve a puzzle, then go there to solve a puzzle, then go to a puzzle somewhere else. What we really wanted to bring was that sense of going on an adventure, of going on a quest."[^ref-27]
...
The game was developed using the new SCI1 (Sierra Creative Interpreter version 1) engine, which Corey Cole described as including "a scripting language, graphic and sound features, the parser, ways to animate characters, and so on."[^ref-28] Cole noted that about one-third of the SCI system was coded in assembly language, and the team was also responsible for porting to Atari ST, Amiga, and Macintosh platforms.[^ref-28]
...
King's Quest V was Sierra's first VGA game and one of the first VGA games ever released, featuring 256-color graphics at 320x200 resolution.[^ref-30] The game represented the most dramatic visual leap in Sierra's history, with reviewers consistently praising the hand-painted backgrounds as groundbreaking.[^ref-15] The CD-ROM version, released in 1991, was mastered in High Sierra Format and included full voice acting, making it one of the earliest "talkie" games.[^ref-6]

The game's audio system supported multiple sound cards including Game Blaster, Ad Lib, Sound Blaster, and Roland MT-32.[^ref-10] The soundtrack was MIDI-based, composed by Mark Seibert and Ken Allen, featuring over 40 distinct musical pieces for different locations and situations.[^ref-31] The huge increase in storage capacity offered by CD-ROM allowed for both digital sound effects and speech files.[^ref-30]
...
**1999 Collection Requirements:**[^ref-22]
...
Several planned versions of the game were cancelled during development. A Sega CD port was announced but never released.[^ref-6] An Atari ST version was announced for Spring 1991 but was ultimately cancelled.[^ref-6] Some unused dialogue and background scenes exist within the game's data files, including hidden unused game over icons.[^ref-32]

### Version History

| Version | Date | Platform | Notes |
|---------|------|----------|-------|
| Floppy EGA | November 1990 | MS-DOS | 16-color version[^ref-33] |
| Floppy VGA | November 1990 | MS-DOS | 256-color version[^ref-33] |
| CD-ROM | 1991 | MS-DOS | Added voice acting[^ref-6] |
| Amiga | 1991 | Amiga | 32 colors[^ref-28] |
| Macintosh | 1991 | Mac | Port[^ref-6] |
| NES | June 1992 | Nintendo | Konami/Novotrade port[^ref-34] |
| FM Towns | 1991 | FM Towns | Japanese/English voice acting[^ref-35] |
| PC-98 | 1991 | NEC PC-9801 | Japanese market[^ref-6] |
| Windows 3.x | 1992 | Windows | Windows port[^ref-36] |
...
The CD-ROM version's audio quality suffered from echo effects and compatibility issues with early High Sierra-format CD-ROM drives.[^ref-9] Modern players using the Steam version may encounter save game issues, receiving the message "This directory/disk can hold no more saved games."[^ref-37] Solutions include installing community patches from The Sierra Help Pages.[^ref-37]

Common compatibility issues include:
- "Unable to initialize your audio hardware" error on modern systems[^ref-38]
- "Out of heap" errors requiring specific save game workarounds[^ref-38]
- Players must run the game in 256 color mode[^ref-38]
- Older versions may incorrectly detect modern 16-bit sound cards[^ref-38]

### Easter Eggs and Trivia

- **Game Title Pun:** The subtitle "Absence Makes the Heart Go Yonder" is a play on the proverb "Absence makes the heart grow fonder."[^ref-25]
- **Sled/Cape Easter Egg:** In the floppy disk version, after Graham crashes the sled in the snowy mountains, using the cape on the broken sled pile causes a sea creature to mysteriously appear—this was removed from the CD-ROM version.[^ref-39]
- **Contest Winners:** Sierra ran a contest where winners became characters in the game. Amanda Logue and Austin Hartman appear as in-game characters.[^ref-25]
- **Real-World Architecture:** The desert temple exterior is based on "Al Khazneh" in Petra, Jordan.[^ref-25]
- **Sierra Logo Mountain:** A mountain in the game is designed to resemble the Sierra On-Line logo.[^ref-25]
- **Cedric References:** The owl Cedric became so notorious that he appeared as the brunt of jokes in later Sierra games including Freddy Pharkas: Frontier Pharmacist, Quest for Glory: Shadows of Darkness, and Space Quest VI.[^ref-26]
- **Unused Dialogue:** Files contain one unused line where King Graham says "I'll take care of you, Cedric."[^ref-34]

## Voice Cast

| Character | Voice Actor |
|-----------|-------------|
| King Graham / Innkeeper's Pal | [[Josh Mandel]] |
| Narrator | Art Lewicki |
| Cedric the Owl | Richard Aronson |
| Crispin / Toymaker / Innkeeper | Leonard "Ray" Bergeron |
| Mordack | Andy Hoyos |
| Prince Alexander / Eagle / Toymaker's Son / Rocky | Barry T. Smith |
| Princess Cassima | Dianah Pressley |
| Rosella / Alicia / Queen Beetrice / Willow | Diana Rose Wilson |
...
| Sir Greywolf | Frederic Gott |
| Toymaker's Granddaughter | Kristen Hoyos |
| Hermit | Bill Davis |
| The Cat / Irate Customer | [[Guruka Singh Khalsa]] |
...
The antagonist Mordack is directly connected to King's Quest III's villain Manannan, being his brother and seeking revenge for Alexander's transformation of Manannan into a cat.[^ref-6] This creates narrative continuity across the series while establishing stakes that feel personal to the royal family. The game's events set up the romance between Alexander and Cassima that drives King's Quest VI, as Alexander has "seen an image of Princess Cassima in his magic mirror, which tells him that she has been captured by an evil vizier on the Land of the Green Isles."[^ref-53]
...
[^ref-7]: [King's Quest Omnipedia – King's Quest V](https://kingsquest.fandom.com/wiki/King's_Quest_V) – sales records, version information
...
[^ref-26]: [Wikipedia – King's Quest Series](https://en.wikipedia.org/wiki/King's_Quest) – series overview, Serenia connection, Cedric references
[^ref-27]: [The Digital Antiquarian – King's Quest V Search Results](https://www.filfre.net/?s=King%27s+Quest+V) – Roberta Williams design philosophy
[^ref-28]: [The Adventurer's Guild – Introduction](https://advgamer.blogspot.com/2015/03/game-52-kings-quest-v-absence-makes.html) – Corey Cole comments, SCI engine details
[^ref-29]: [IMDB – King's Quest V Full Credits](https://www.imdb.com/title/tt0212279/fullcredits) – complete production credits, voice cast
[^ref-30]: [SCI Wiki](https://sci.sierrahelp.com/) – SCI1 technical information, CD-ROM capabilities
[^ref-31]: [Game Grumps Wiki – King's Quest V](https://gamegrumps.fandom.com/wiki/King's_Quest_V:_Absence_Makes_the_Heart_Go_Yonder!) – music details, version information
...
[^ref-40]: [King's Quest Omnipedia – Sales Data](https://kingsquest.fandom.com/) – Ken Williams sales report
[^ref-41]: [Hardcore Gaming 101 Blog](http://blog.hardcoregaming101.net/2012/04/) – sales success, awards
[^ref-42]: [GOG Forums – Manual Discussion](https://www.gog.com/forum/kings_quest_series/kings_quest_6_manual_is_missing_sections) – collection version information
