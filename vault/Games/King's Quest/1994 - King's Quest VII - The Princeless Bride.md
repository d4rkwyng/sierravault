...
> **Design/Writing:** [[Roberta Williams]], [[Lorelei Shannon]][^ref-1]
> **Publisher:** Sierra On-Line[^ref-1]
> **Engine:** SCI2.1[^ref-9]
> **Platforms:** MS-DOS, Windows 3.x, Windows 95, Macintosh[^ref-9]
> **Release Year:** 1994
> **Series:** King's Quest
> **Protagonist:** Princess Rosella, Queen Valanice
...
The game received generally positive reviews, with critics praising the animation while expressing reservations about difficulty:
...
- **Animation Magic Inc.** (St. Petersburg, Russia) – Global animations and Chapter 1
- **Dungeon Ink & Paint** (South Carolina, USA) – Chapters 2, 3, and 5
...
The original release was notoriously buggy due to a rushed Christmas deadline:[^ref-1][^ref-21][^ref-22]

**Known Bugs (fixed in patches):**
- Lockup when Rosella walks through forest
- Lockup when taking the wooden nickel from mockingbird
- Stuttering mockingbird
- Looping at the hummingbird/spiderweb scene
- Wooden nickel not highlighting in Faux Shop
...
Significant content was cut during development:[^ref-4][^ref-21]

- **King Graham ending scene** – Voice dialogue was recorded for Graham greeting Valanice and Rosella upon their return ("Ladies, I was getting worried! You're 15 minutes late for lunch!") but the scene was cut. In version 1.4, Graham appears in the credits played by Denny Delk; this line was removed in later versions.[^ref-2][^ref-20]
- **Fattipuffs and Thinnifers kingdom** – A cut region with "good-natured creatures who loved to eat and party" versus "uptight creatures who dieted and exercised"
- **Extended Were-Woods** – Originally larger with additional puzzles
- **Fire Town** – A Flame Folk settlement in the Vulcanix Underground
- **Jack O'Lantern** – A cut character from Ooga Booga
- **Crystal Dragon Tail puzzle** – Removed in version 2.0; originally required timing the chisel when the dragon's tail raised
- **Eighth chapter** – The game was edited from seven or eight chapters down to six plus ending
...
| Actor | Characters |
|-------|------------|
| Maureen McVerry | Rosella |
| Carol Bach y Rita | Valanice, Titania |
| Ruth Kobart | Malicia, Crystal Dragon |
| Jesse Moises | Edgar, False Troll King |
| Denny Delk | King Otar Fenris III |
| Roger Jackson | Cuddles, Kangaroo Rat, Snake Oil Salesman, Three-Headed Carnivorous Plant |
| Timothy Alexander White | Oberon |
...
The game maintains an active speedrunning community. The current world record for "All Chapters" is 48 minutes 27 seconds, set by AdmiralJay.[^ref-26] The speedrun.com leaderboard tracks 70 runs by 15 players.[^ref-26]

### Collections

The game has appeared in numerous compilations:[^ref-1]

- **The Roberta Williams Anthology** (1996)
- **King's Quest: Collection Series** (1997)
- **Best of Sierra Nr. 2** (1997)
- **King's Quest Collection** (2006) – Steam release[^ref-27]
- **King's Quest 7+8** (2010) – GOG.com[^ref-17]
...
- [GOG – King's Quest 7+8](https://www.gog.com/en/game/kings_quest_7_8)
