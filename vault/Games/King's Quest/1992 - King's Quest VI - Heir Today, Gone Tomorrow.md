...
designer: [Roberta Williams, Jane Jensen]
publisher: Sierra On-Line
genre: Adventure
platforms: [DOS, Windows 3.x, Mac, Amiga]
series: King's Quest
engine: SCI1.1
...
tags: [1990s, adventure, jane-jensen, king-s-quest, roberta-williams, sci, sierra]
---
...
> **Design/Writing:** [[Roberta Williams]], [[Jane Jensen]][^ref-3]
> **Publisher:** Sierra On-Line[^ref-4]
> **Engine:** SCI1.1[^ref-8]
> **Platforms:** MS-DOS, Windows 3.x, Macintosh, Amiga[^ref-4]
> **Release Year:** 1992[^ref-4]
> **Series:** King's Quest
> **Protagonist:** Prince Alexander
...
The puzzle design reflects the combined sensibilities of both designers. Jane Jensen specifically claimed credit for the Cliffs of Logic sequence: "I would say I can claim responsibility for the Cliffs of Logic, though. That's definitely my kind of puzzle"[^ref-17]. This challenging obstacle requires players to reference the Guidebook to the Land of the Green Isles, the game's copy protection manual, to translate Ancient Ones inscriptions and solve riddles involving word order and logic[^ref-13].

The Isle of Wonder features puzzles playing on Lewis Carroll wordplay, with literal representations of figures of speech—the Oxymoron creature, a Dangling Participle, a stick-in-the-mud, and a bump-on-a-log all serve as inventory items or puzzle elements[^ref-9][^ref-12]. George Starostin called the Isle "the most colorfully absurdist that King's Quest ever got," likely attributable to Jensen's influence[^ref-12].

Magic plays a central role on the long path, with Alexander learning three spells from a magic spellbook: "Make Rain," "Charming a Creature of the Night," and "Magic Paint"[^ref-18]. These require gathering specific ingredients across the islands and enable access to otherwise unreachable areas and solutions.

The game does contain dead ends and death scenarios—criticized by some reviewers—though "nowhere near the level of the previous game"[^ref-9]. The minotaur's labyrinth is particularly unforgiving: entering without specific objects guarantees an inescapable situation[^ref-12].
...
- MobyGames: 8.1 MobyScore, 83% critics (27 reviews)[^ref-20]
...
George Starostin noted the significance of the cast: "The first ever appearance in a computer game of the inimitable Dave Fennoy (much-later-to-be Lee Everett in TellTale's The Walking Dead) in a relatively small, but important role of Pawn Shop Owner"[^ref-12]. He also observed that Robby Benson "had just provided his voice for Disney's Beast," creating an actor allusion given the game's Beauty and the Beast-inspired island[^ref-12].

### Girl in the Tower

The love theme "Girl in the Tower" became an unusual case study in video game marketing. Composed by Mark Seibert with lyrics by Jane Jensen and performed by Bob Bergthold and Debbie Seibert, the ballad was inspired by Cassima's theme from King's Quest V[^ref-29][^ref-30].
...
|---------|------|----------|-------|
| 1.000 | September 27, 1992 | DOS Floppy | Original US release[^ref-8] |
...
The game features at least a dozen ending variations based on player choices[^ref-14]. Key variables include:
...
The "best" ending requires sending the ring via Sing-Sing the nightingale, befriending Jollo, rescuing the king and queen, saving the genie, and recovering all stolen treasures. This ending features Jollo performing at the wedding, Shamir's magical tricks, attendance by rulers of all islands, and the arrival of King Graham, Queen Valanice, and Princess Rosella from Daventry[^ref-14].
...
This game has been included in[^ref-20][^ref-21]:
...
- [GOG.com – King's Quest 4+5+6](https://www.gog.com/en/game/kings_quest_4_5_6) – Includes both floppy and CD-ROM versions, ScummVM-powered
...
- [Two Guys Records – An Ode to the Isles](https://www.discogs.com/release/31112489) – 2024 vinyl soundtrack reorchestration
