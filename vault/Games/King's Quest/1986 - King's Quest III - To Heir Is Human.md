...
genre: Adventure
platforms: [DOS, Apple II, Apple IIGS, Amiga, Atari ST, Mac, Tandy Color Computer
    3]
series: King's Quest
engine: AGI
...
> **Platforms:** MS-DOS, Apple II, Apple IIGS, Amiga, Atari ST, Macintosh, Tandy Color Computer 3[^ref-6]
> **Release Year:** 1986
> **Series:** King's Quest
> **Protagonist:** Gwydion (Prince Alexander)
...
The game opens in the land of Llewdor, far from the familiar kingdom of Daventry, where a young man named Gwydion serves as a slave to the wicked wizard Manannan.[^ref-2] Manannan is described as "an abusive bastard who will quite literally kill the boy if he's lax in doing his chores."[^ref-7] Gwydion has no memory of his origins, having been kidnapped as an infant and raised in servitude atop the wizard's mountain home. The wizard keeps Gwydion under constant surveillance, returning periodically to check on his slave and punish any signs of disobedience or independent thought.[^ref-8]
...
The game is structured around a real-time clock mechanic that governs the wizard Manannan's schedule of departures and returns.[^ref-7] This creates distinct gameplay phases:
...
- **Llewdor Wilderness:** An explorable overworld containing various locations needed for spell components, including a village, seashore, and the three bears' cottage.[^ref-7]
...
The game contains several notable Easter eggs and hidden responses:[^ref-14]
...
- **Three Bears Cottage:** Players can sleep in one of the three bears' beds and steal their porridge for spell ingredients, referencing the Goldilocks fairy tale.[^ref-7]
...
- **Game Manual:** Included essential spell formulas required to complete the game, serving as copy protection[^ref-14]
- **King's Quest Collection II Manual:** Contains historical context about the game's initial reception[^ref-14]
...
- [GOG](https://www.gog.com/game/kings_quest_1_2_3) - Available in King's Quest 1+2+3 bundle
- [Steam](https://store.steampowered.com/app/10100/Kings_Quest_Collection/) - Part of King's Quest Collection

**Download / Preservation**
- [Internet Archive](https://archive.org/details/msdos_Kings_Quest_III_-_To_Heir_is_Human_1986)
- [ClassicReload](https://classicreload.com/kings-quest-iii-to-heir-is-human.html) - Browser playable[^ref-2]
...
The game's events directly set up King's Quest IV: The Perils of Rosella, which begins moments after the conclusion of this game. King Graham's heart attack and Rosella's quest to save him flow naturally from the emotional reunion depicted here.[^ref-2] Alexander would return as the protagonist in King's Quest VI: Heir Today, Gone Tomorrow, completing his journey from enslaved orphan to heroic prince.
