...
> **Designer:** Matt Korba[^ref-4]
> **Publisher:** [[Activision]][^ref-3]
> **Engine:** Unreal Engine 3[^ref-2]
> **Platforms:** Windows, PlayStation 3, PlayStation 4, Xbox 360, Xbox One
> **Release Year:** 2015
> **Series:** King's Quest
> **Protagonist:** Graham
...
The game offers entirely new stories and characters, but they often reference the earlier games[^ref-3]. The new stories are not told in chronological order and are interspersed with sections in the present that revolve around Gwendolyn[^ref-3]. The protagonist is Graham, the same protagonist who first appeared in the original King's Quest in 1984[^ref-3].

The game consists of five chapters[^ref-3]:
...
The Complete Collection includes an exclusive epilogue that shifts perspective to Gwendolyn, who applies the lessons learned from her grandfather's stories during her first independent adventure[^ref-4].

## Gameplay

The game environment is shown through different perspectives for each scene with scrolling parts, but the camera cannot be controlled[^ref-3]. Visually it has a cel-shaded graphical style[^ref-3]. The player can move Graham freely in the 3D environment[^ref-3].

### Interface and Controls
- When Graham is close to an interesting element, this is signified through one or multiple icons in the bottom right corner of the screen[^ref-3]
- The player can choose to examine, interact, or pick up objects[^ref-3]
- Collected items are stored in an inventory[^ref-3]
- In many locations it is possible to switch to a first-person perspective to examine the environment[^ref-3]

### Structure and Progression
- The game largely focuses on the story and puzzle-solving, but there is also a large amount of exploration and action sequences with escapes and fighting[^ref-3]
- Graham often needs to run and he can also push or manipulate objects in various ways[^ref-3]
- These sections are sometimes shown from a first-person perspective[^ref-3]
- There are many cut-scenes, on-rails sequences, and some Quick Time Events[^ref-3]

### Puzzles and Mechanics
- The game incorporates choices and consequences in various ways and they are carried across episodes[^ref-3]
- There are many branching dialogue options that lead to different outcomes[^ref-3]
- Puzzles often have multiple approaches without a fixed solution[^ref-3]
- Generally there are three types of choices to make or paths to follow: bravery, wisdom, or compassion, though these are never mentioned explicitly[^ref-3]
- This affects the story and especially the way Gwendolyn will act in the present as her grandfather's stories are the inspiration for her acts[^ref-3]
- These choice elements hearken back to the original King's Quest games, such as the multiple ways Graham could deal with the dragon in the first game[^ref-3]

## Reception

### Contemporary Reviews
Adventure Gamers awarded the game an "Excellent" rating of 4.5/5, stating: "A revival of a classic adventure series, the episodic King's Quest is itself an instant classic, giving each new installment its own unique focus. Wise, brave, and compassionate adventurers alike should definitely consider having a crack at it"[^ref-6]. Critics praised the innovative narrative structure using the grandfather-granddaughter framing device, which allowed for heartfelt storytelling while explaining the game's death mechanics in a clever way[^ref-3][^ref-6].

IGN's Leif Johnson awarded Chapter 1 an 8/10, praising the game as "full of humor, heart, and beauty" and calling it "an admirable revival of classic adventure games"[^ref-9]. He noted that "there's hardly an environment in the whole story that doesn't evoke some awe"[^ref-9]. ZTGD gave Chapter 1 a 9.5/10 "Excellent" rating, calling it "the surprise hit of 2015" with "hilarious writing with a stellar VO cast"[^ref-10].

GameFAQs users gave the game a rating of "Great" based on 26 ratings, with an average completion time of 30 hours for the full series[^ref-4]. The game's reimagining of classic King's Quest elements, particularly the tower sequence from King's Quest II, received praise for its creative approach to series mythology[^ref-3]. The hand-drawn cel-shaded graphical style was widely praised for capturing the whimsical fairy-tale atmosphere of the original series while bringing it into the modern era[^ref-3][^ref-6].

Digitally Downloaded's review of the complete series praised the narrative structure, stating "Creative Director Matt Korba should be given some sort of award for his work with this game" and concluding that "King's Quest does everything right"[^ref-11]. The reviewer noted being brought to tears by Graham's death scene in Chapter Five[^ref-11].
...
On Steam, the game has accumulated 2,933 reviews with a "Very Positive" aggregate rating (90% positive)[^ref-17]. The Steam community has particularly praised the game's storytelling, humor, and faithfulness to the spirit of the original series while modernizing the gameplay[^ref-17]. Recent reviews remain "Very Positive," indicating continued appreciation from new players discovering the game[^ref-17].

- **Steam:** Very Positive (2,933 reviews, 90% positive)[^ref-17]
- **MobyGames:** 7.3/10 MobyScore, 3.8/5 player rating (13 ratings)[^ref-3]
- **GameFAQs:** "Great" user rating (26 ratings)[^ref-4]
...
- **Completion Time:** 30 hours average for full series; ~5 hours per chapter; 55 hours for completionists[^ref-4][^ref-10][^ref-14]
...
- Multi-platform release across Windows, PlayStation 3, PlayStation 4, and Xbox One[^ref-3]
- Choice-consequence mechanics tracking player decisions across virtue categories (bravery, wisdom, compassion)[^ref-3]
- Branching dialogue system affecting narrative outcomes across all five episodes[^ref-3]
- First-person perspective mode for detailed environmental examination[^ref-3]
- Quick Time Events integrated into action sequences[^ref-3]
- Released: July 28, 2015 (Chapter 1), with subsequent chapters through October 2016[^ref-4]

## Legacy

King's Quest (2015) played a crucial role in reviving interest in the dormant franchise, which had seen no major entries since 1998's King's Quest: Mask of Eternity[^ref-1]. The reboot demonstrated the enduring appeal of whimsical adventure gaming and fairy-tale storytelling, drawing both longtime fans and newcomers to explore the series' rich heritage.

The game's innovative narrative structure, blending traditional adventure game mechanics with choice-driven storytelling through the grandfather-granddaughter framing device, influenced modern episodic adventure design[^ref-3]. Creative Director Matt Korba confirmed that King's Quest: Mask of Eternity is canon to the 2015 reboot, though Connor did not ultimately appear in the game[^ref-1].

The series remains available through digital distribution on Steam[^ref-5].

## Downloads

**Purchase / Digital Stores**

- [Steam – King's Quest](https://store.steampowered.com/app/345390)[^ref-5]

This game is not available on GOG[^ref-7].

**Manuals & Extras**

- [MobyGames – King's Quest: The Complete Collection](https://www.mobygames.com/game/74033/kings-quest-the-complete-collection/) – covers, screenshots, credits[^ref-3]
...
[^ref-10]: [ZTGD – King's Quest Chapter 1 Review](https://ztgd.com/kings-quest-chapter-1-a-knight-to-remember-xb1-review/) – 9.5/10 review, gameplay length, puzzle design
[^ref-11]: [Digitally Downloaded – King's Quest Complete Series Review](https://www.digitallydownloaded.net/2017/01/review-kings-quest-sony-playstation-4.html) – full series review, voice cast details, Matt Korba creative direction
[^ref-12]: [Rock Paper Shotgun – King's Quest Review](https://www.rockpapershotgun.com/kings-quest-chapter-1-review) – voice cast details including Tom Kenny, Loretta Devine, Kevin Michael Richardson
