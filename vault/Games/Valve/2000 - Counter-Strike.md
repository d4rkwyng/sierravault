...
Half-Life: Counter-Strike is a 2000 tactical first-person shooter game developed by Valve Corporation and published by Sierra Studios that began life as a free modification for the original Half-Life before becoming a standalone retail product.[^ref-1][^ref-59] Originally created by two modders—Minh "Gooseman" Le and Jess "Cliffe" Cliffe—the game pits two teams against each other: terrorists and counter-terrorists, competing across a variety of objective-based scenarios.[^ref-2][^ref-60] The game has been called one of the most influential first-person shooters ever made and is noted for its realistic and tactical approach to counter-terrorism gameplay.[^ref-1]
