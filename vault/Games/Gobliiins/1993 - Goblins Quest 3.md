---
title: Goblins Quest 3
release_year: 1993
developer: Coktel Vision
designer: [Pierre Gilhodes, Muriel Tramis]
publisher: Sierra On-Line
genre: Puzzle
platforms: [DOS, Amiga, Mac, Windows]
series: Gobliiins
engine: Gob
protagonist: Blount
...
> **Designer:** [[Pierre Gilhodes]], [[Muriel Tramis]][^ref-5]
> **Publisher:** [[Sierra On-Line]], Coktel Vision[^ref-1]
> **Engine:** Gob[^ref-6]
> **Platforms:** MS-DOS, Amiga, Macintosh, Windows (via ScummVM)[^ref-1]
> **Release Year:** 1993
> **Series:** Gobliiins
> **Protagonist:** Blount
...
The game's narrative centers on the legendary Labyrinth of Foliandre, said to harbor great secrets that might fulfill the wishes of those who discover them[^ref-7]. For thousands of years, two kingdoms ruled by Queen Xina and King Bodd have competed fiercely to be the first to conquer the labyrinth in the bowels of Mount Foliandre[^ref-8]. According to legend, the goblin who manages to overcome all the tests in the labyrinth will win eternal benefit for their people, with the fabulous "Jewel of the World" at its heart securing an eternity of pleasure for its owner[^ref-9].
...
Goblins Quest 3 employs a point-and-click interface typical of early 1990s adventure games[^ref-12]. Players use the mouse to interact with objects, characters, and the environment, combining items in their inventory to solve puzzles[^ref-12]. The game utilizes "bright, expressive VGA graphics" running at 256 colors, with most areas being larger than the screen and therefore scrolling as players explore[^ref-1][^ref-11]. Unlike many adventure games of the era, Goblins Quest 3 features a "you-can't-die-no-matter-what-you-do" design philosophy, encouraging experimentation without fear of failure[^ref-12].

### Structure and Progression

The game consists of 18 different levels, with some levels being interconnected[^ref-11]. Most levels occupy more than one screen, allowing for limited navigation within confined puzzle areas[^ref-7]. Like its predecessors, the emphasis is on solving complex tasks within smaller areas rather than expansive exploration[^ref-7]. The game includes a joker system—five jokers are available that provide extra clues when players become stuck[^ref-13].

**Level Structure:**
- **The Vessel:** Opening sequence aboard Blount's flying ship[^ref-14]
- **The Countryside:** Aftermath of the crash landing[^ref-14]
- **The Town:** Urban environment with various characters[^ref-14]
- **The Clouds:** Elevated puzzle sequences[^ref-14]
- **The Labyrinth:** Final challenges within Mount Foliandre[^ref-8]

### Puzzles and Mechanics

The puzzles in Goblins Quest 3 are designed to "test your brain power to the max," according to Gamer Walkthroughs[^ref-15]. While Blount is the primary controllable character, each level features a secondary character who assists in puzzle-solving but cannot pick up objects[^ref-8]. These sidekicks include Chump the parrot, Ooya the magician, and Fulbert the snake[^ref-11]. Players must coordinate actions between Blount and his current companion to solve the game's intricate puzzles.

A unique mechanic involves Blount's werewolf transformation. When exposed to moonlight, Blount spontaneously transforms into a werewolf, and the hero undergoes several other mutations, drastically changing his size during the course of the game[^ref-16]. Players must strategically use both forms to overcome obstacles. The game also features potion-crafting mechanics, with players creating various elixirs such as Growlixir, Speedixir, Wingixir, and Memorum throughout gameplay[^ref-14]. One puzzle notably requires restoring a dragon's memory with the Memorum potion before he will help the player[^ref-14].

## Reception

### Contemporary Reviews

Goblins Quest 3 received generally positive reviews upon release, though opinions varied somewhat between publications. Computer Gaming World awarded the game 3.5 out of 5 stars in their July 1994 review, praising its "charming characters and goofy plot elements" while noting that "puzzle lovers are guaranteed an enjoyably bizarre experience"[^ref-1]. Amiga User International gave the game an 85 out of 100 in April 1994, while Amiga Format scored it 80 out of 100 in February 1994[^ref-5]. Amiga Power awarded 77 out of 100 in February 1994, and Amiga Joker gave 74 out of 100 in January 1994[^ref-5].

The game received more mixed coverage from CU Amiga, which awarded only 53% in their February 1994 review by Tony Dillon[^ref-1]. PC Gamer was notably enthusiastic, declaring it one of the best puzzle games available and stating that "its puzzles will challenge and delight even the most experienced gamers"[^ref-1]. The game earned the distinction of being ranked as the 42nd best computer game ever by PC Gamer US in 1994, and also received their 1994 Best Puzzle Game award[^ref-1].
...
- **Abandonware DOS:** 4.00/5 (34 votes)[^ref-2]
- **MyAbandonware:** 4.63/5[^ref-17]
- **Amazon:** 4.8/5 (3 ratings)[^ref-18]
- **GameFAQs:** 7/10[^ref-12]

## Development

### Origins

Goblins Quest 3 was developed by Coktel Vision, a French game developer that had established the Gobliiins series in 1991[^ref-19]. The series was created by [[Pierre Gilhodes]] and [[Muriel Tramis]], with Gilhodes contributing the unique visual look that became the signature style of not only the Goblins games but many of Coktel Vision's other titles[^ref-19]. Gilhodes "became a graphic artist at a very early age" and began creating video games with Coktel Vision in 1990[^ref-20]. The conceptual premise of the series—where the number of "i"s in the title indicates the number of playable goblins—was cleverly carried through to its logical conclusion in this third installment[^ref-1].

### Production

The game was released in the US shortly after Sierra On-Line's acquisition of Coktel Vision, and Sierra's influence is apparent in the addition of the word "Quest" to the title, aligning it with Sierra's other popular Quest series[^ref-3]. This was the last Goblins game published by Sierra On-Line[^ref-8]. The development team crafted what the box described as "another mind-bending, plot-twisting, brain-teasing puzzle adventure"[^ref-13].
...
The game utilized Coktel Vision's proprietary Gob engine, which powered several of the studio's adventure titles[^ref-6]. The engine supported VGA 256-color graphics at 320x200 resolution, with scrolling screens that were larger than the display area[^ref-6][^ref-11]. A distinctive audio feature was the "goblinish" speech system—whenever characters spoke, their voices were rendered in gibberish sounds appropriate to each character, which "actually added a lot of funny moments to the game"[^ref-5]. The CD-ROM version later replaced this with actual voice acting featuring Sierra-style speech boxes[^ref-3].

### Technical Specifications

**CD-ROM Version:**[^ref-3][^ref-5]
- **Resolution:** 320x200, 256 colors (VGA)
- **Audio:** AdLib, Sound Blaster, Pro AudioSpectrum, Intersound MDO, PC Speaker[^ref-21]
- **Audio Format:** CD Audio tracks (Red Book Audio), ADL format for floppy[^ref-21]
- **Features:** Full voice acting, Sierra-style speech boxes, different music from floppy version

**Floppy Disk Version:**[^ref-3]
...
- **Installer Size:** Approximately 1.01 MB[^ref-4]
...
|---------|------|----------|-------|
| 1.0 | 1993 | DOS/Amiga | Initial European release as "Goblins 3"[^ref-1] |
| US Release | March 18, 1994 | DOS | Sierra release with "Quest" suffix[^ref-21] |
| CD-ROM | 1994 | DOS | Added voice acting, different music, censored some nudity[^ref-1] |
| ScummVM | March 23, 2010 | Windows | Re-release with ScummVM compatibility[^ref-6] |
| GOG | 2018 | Windows | DotEmu re-release, version 1.02[^ref-22] |

### Technical Issues

The game has experienced various compatibility issues on modern systems. Users on VOGONS forums reported crashes occurring "a couple seconds after" starting the game on Windows XP systems[^ref-23]. The Coktel Vision games "just seem to not like the NT version of MSCDEX, MACDEXNT," according to community member "collector"[^ref-23]. The recommended solution is to use "SAPUCDEX with VDMSound," which makes "most of the Coktel Vision games seem to work even better than with Windows 9x or DOS 7"[^ref-23]. Modern players are advised to use ScummVM or the GOG re-release for optimal compatibility[^ref-4].

### Easter Eggs and Trivia

- The protagonist Blount is revealed to be the kidnapped prince from Gobliins 2: The Prince Buffoon, creating a direct narrative connection between games[^ref-11]
- The game features copy protection using a color grid reference system[^ref-5]
- The Amiga version was deprived of some between-levels screens present in other versions[^ref-5]
- Characters speak in "goblinish"—gibberish sounds rendered in voices appropriate to each character—in the floppy disk version[^ref-5]
- The music in the floppy disk version is composed of entirely different tunes than the CD-ROM version[^ref-3]
- In Gobliins 2, Fingus will whistle a different tune in each room if left idle—a charming detail carried through the series' attention to character personality[^ref-19]

## Legacy

### Sales and Commercial Impact

Goblins Quest 3 achieved notable recognition during its release era. PC Gamer US ranked it as the 42nd best computer game ever in 1994 and awarded it their Best Puzzle Game honor that same year[^ref-1]. The game also won the Amiga Joker Readers' Vote for #3 Best Genre Mix in 1994[^ref-5]. As the final entry in the original trilogy published by Sierra On-Line, it represented the culmination of Coktel Vision's puzzle-adventure formula[^ref-8].

### Collections

The game has been re-released digitally through various platforms. It is available on GOG.com through DotEmu, which handles modern distribution[^ref-22]. The entire Gobliiins series was also made available on Steam in July 2023, ensuring the games remain accessible to modern audiences[^ref-1]. The game can be played through ScummVM, which has supported the Gob engine since 2010[^ref-4].
...
- **Universal Hint System:** UHS offered hints for Goblins 3, providing progressive clue reveals to avoid spoilers[^ref-25]
- **Various Walkthrough Guides:** Multiple fan-created walkthroughs are available on GameFAQs and dedicated gaming sites[^ref-14][^ref-15]
...
Modern critics recognize the game as "a great finale to a great series," noting that "it undoubtedly has the best story, the best graphics and animations, and the best music" of the trilogy[^ref-3][^ref-13]. The game's influence on puzzle-adventure design can be seen in its integration of character transformation mechanics, companion-based puzzle-solving, and commitment to player-friendly design that eliminated death penalties. While overshadowed in gaming history by larger Sierra franchises, Goblins Quest 3 remains beloved among adventure game enthusiasts and continues to find new audiences through digital distribution platforms.

## Downloads

**Purchase / Digital Stores**
- [GOG](https://www.gog.com/game/gobliiins_pack) - Included in Gobliiins Pack
- [Steam](https://store.steampowered.com) - Available as part of Gobliiins collection
