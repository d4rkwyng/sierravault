...
> **Designer:** Thomas J. Mitchell (Original Concept)[^ref-5]
...
Oil's Well utilizes a simple yet challenging control scheme appropriate for its arcade-style gameplay.[^ref-7] Players use four directional controls to maneuver the drill head through the underground maze while a dedicated button allows for quick retraction of the drilling apparatus.[^ref-7] The 1990 DOS version supports both keyboard and mouse input methods.[^ref-5][^ref-9]

The player controls a drilling bit that leaves behind a pipeline as it moves through the underground tunnels.[^ref-3] This trailing pipe creates the core strategic challenge – the entire length of the drilling apparatus is vulnerable to enemy contact, not just the drill head itself.[^ref-3][^ref-7] One touch from the underground creatures to any part of the robotic arm results in losing a life.[^ref-7][^ref-8]

### Structure and Progression

The game features eight distinct levels that players must navigate through, with difficulty increasing progressively as players advance.[^ref-1][^ref-3] The three difficulty levels are uniquely named "Regular," "Unlimited," and "Premium" rather than using traditional easy/medium/hard designations.[^ref-8] After completing all eight levels, players can continue playing through additional challenges.[^ref-1]

- **Levels 1-8:** Core gameplay stages with increasing difficulty[^ref-1]
- **Beyond Level 8:** Extended gameplay for skilled players[^ref-1]
- **Cartoon Rewards:** Each completed level unlocks a short animated movie featuring Slater[^ref-1][^ref-5]

The game supports 1-2 players, allowing for competitive or alternating play sessions.[^ref-5][^ref-8]
...
The original 1983 version of Oil's Well received considerable critical acclaim across multiple platforms. ANALOG Computing described it as a "truly different and challenging" variant on the traditional dot-collecting gameplay formula.[^ref-3] Dave Stone of Computer Gaming World noted that "the action's well-paced, the difficulty progressive. While getting to a higher level is somewhat dependent on getting the right breaks — good eye-hand coordination, timing, and strategy are essential."[^ref-3]

Ahoy! magazine found the "gameplay is, in my experience, unique" and gave it a "Recommended" rating.[^ref-3] InfoWorld called it "a clever, basic game,"[^ref-3] while InfoWorld's Essential Guide to Atari Computers labeled it "Sierra's trickiest."[^ref-3][^ref-4] In December 1983, InfoWorld magazine gave Oil's Well the edge over competing title Ardy the Aardvark for its "super-fast gameplay."[^ref-6]

The 1990 remake received more mixed reception. MobyGames user reviews noted that the "soundtrack is brilliantly composed by Ken Allen, and blends in with the game's overall theme."[^ref-5] However, some reviewers questioned Sierra's decision to remake this particular title, with one noting "I don't know why Sierra chose Oil's Well to make a remake of and not something else."[^ref-5] Home of the Underdogs described it as "a fun little clone of classic Digger" that is "fast, fun, but somehow missing the longevity that makes Digger a classic."[^ref-11]

### Modern Assessment

Modern retrospective assessments generally favor the original over the remake. Home of the Underdogs stated that "the 1990 remake version is much better" than the original, though they noted it remained "good for nostalgia, but little else."[^ref-11] Retrospective analysis concluded that "while the 1990 release of Oil's Well is cute and enjoyable, the original version is the better of the two."[^ref-6]

User reviews on abandonware sites have been notably harsh, with one reviewer calling the game "frustrating, annoying, and lame, even by 1990s standards."[^ref-9] The game was characterized as an "addictive arcade game where you control a robotic arm trying to mine oil in the underground tunnels."[^ref-5]

**Aggregate Scores:**
- **MobyGames (1990 version):** 6.1/10, Critics: 47% (3 ratings), Players: 3.0/5 (13 ratings)[^ref-5]
- **MobyGames (1983 original):** 7.7/10, Critics: 81%, Players: 3.9/5[^ref-8]
- **MyAbandonware (1990 version):** 4.25/5 (12 votes)[^ref-9]
- **MyAbandonware (1983 original):** 4.25/5 (8 votes)[^ref-11]

**Historical Review Scores (1983 original):**[^ref-8]
...
**DOS Version (1990):**[^ref-5][^ref-6][^ref-9]
...
**Emulation Compatibility:**[^ref-9]
- **DOSBox:** Supported
- **Archive.org Item Size:** 18.3 MB (full archive)[^ref-1]
...
|---------|------|----------|-------|
| 1.14 | 1990 | DOS | VGA Remake - initial release[^ref-12] |
| 1.15 | 1990 | DOS | VGA Remake - minor update[^ref-12] |

For versions of the original 1983 game, see [[1983 - Oils Well|Oil's Well (1983)]].

### Technical Issues

Users have reported several compatibility issues with the 1990 DOS version:[^ref-9][^ref-13]

- **Control Mapping Issues:** Some DOSBox configurations result in mouse controls instead of the expected arrow keys and spacebar, significantly altering gameplay[^ref-9]
- **Version Confusion:** Download sites have occasionally provided the 1984 CGA version instead of the 1990 VGA remake[^ref-9]
- **Vintage Hardware Compatibility:** Testing on NEC Mobile Gear MC-MK12 showed the 1990 version runs but lacks keyboard input functionality[^ref-13]

### Easter Eggs and Trivia

- **Title Pun:** The game's title "Oil's Well" is a pun on the phrase "all's well"[^ref-3][^ref-6]
- **Final Cartoon:** The last animated sequence features a limousine with the words "Oils Well That Ends Well"[^ref-5]
- **Debug Mode:** A debug mode can be activated by creating a file named BETA.DAT containing the string "Taito SoftwareOW" – pressing F8 grants invincibility while F7 allows skipping levels[^ref-14]
- **Developer Connections:** Bill Sargent, who worked on the original 1983 version, went on to work on The Sims and SimCity 2000[^ref-7]
- **Difficulty Naming:** The three difficulty levels are humorously named "Regular," "Unlimited," and "Premium" – referencing gasoline grades[^ref-8]

## Legacy

### Sales and Commercial Impact

The original 1983 Oil's Well "managed to do what Anteater couldn't and became a solid hit."[^ref-6] The game's success earned it Computer Games Magazine's 1984 Golden Floppy Award for Excellence in the Maze Game of the Year category.[^ref-3][^ref-6] This recognition cemented the game's status as one of the standout arcade-style games of its era.

The 1990 remake represented Sierra's attempt to capitalize on the nostalgia for classic arcade games during the VGA graphics era, though critical reception suggested the updated version struggled to justify its existence in a marketplace with significantly higher expectations for gameplay depth.[^ref-6]

### Collections

Oil's Well (1990) was included in the compilation **Action Five** released in 1992.[^ref-5] This bundle package allowed Sierra to extend the commercial life of the remake by combining it with other action-oriented titles from their catalog.

The game is currently preserved and playable through the Internet Archive's DOS game collection, which hosts thousands of classic games through browser-based DOSBox emulation.[^ref-1]

### Fan Projects

An unofficial conversion of Oil's Well appeared in 2013, continuing the legacy of this classic arcade title.[^ref-8] The game's simple but engaging mechanics have made it a candidate for recreation by hobbyist programmers interested in preserving classic gameplay experiences.

### Related Publications

- **Instruction Manual (Version 1.14/1.15):** Included with the game, documentation by Marti McKenna[^ref-5][^ref-12]
- **Box Materials:** Original packaging included diskette and documentation[^ref-15]

### Critical Perspective

Oil's Well occupies an interesting position in Sierra's catalog as one of their purely arcade-style offerings during an era when the company was primarily known for adventure games. The original 1983 version demonstrated that Sierra could successfully compete in the action game market, offering what critics called "truly different and challenging" gameplay that combined familiar elements in novel ways.[^ref-3]
...
- [Internet Archive – MS-DOS Version](https://archive.org/details/msdos_Oils_Well_1990)[^ref-1]
- [MyAbandonware – Oil's Well (1990)](https://www.myabandonware.com/game/oil-s-well-z1)[^ref-9]

**Play Online**
- [ClassicReload – Oil's Well](https://classicreload.com/oils-well.html)[^ref-7]
- [PlayClassic.Games – Oil's Well](https://playclassic.games/games/arcade-dos-games-online/play-oils-well-online/)[^ref-16]
...
The character of Slater proved popular enough that he was given his own spinoff game, **Slater & Charlie Go Camping**, though this represents a character spinoff rather than a true series continuation.[^ref-5]
