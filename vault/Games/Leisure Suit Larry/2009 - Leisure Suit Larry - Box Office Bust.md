...
> **Designer:** Paul Dunstan[^ref-48]
> **Publisher:** Codemasters[^ref-21]
> **Platforms:** PC, PlayStation 3, Xbox 360[^ref-45]
> **Release Year:** 2009
> **Series:** Leisure Suit Larry
...
Box Office Bust was initially announced by Sierra Entertainment on January 17, 2008[^ref-67][^ref-69][^ref-72], as part of an attempt to revitalize the dormant Leisure Suit Larry franchise. Executive Producer John Melchior explained that the development team wanted to address criticisms of the previous game, Magna Cum Laude, stating "The last game was torn apart and I think it was just the wrong approach for this franchise"[^ref-31].

The development philosophy centered around creating "a good solid story, clever set ups, and great pay offs"[^ref-8], with Melchior emphasizing that "Nudity is a mask for poor gameplay. There is no Nudity in this version of Larry"[^ref-31]. However, the decision to completely overhaul the gameplay mechanics from point-and-click adventure to 3D action-platformer proved controversial from the outset[^ref-57].
...
Modern franchise revivals have pointedly ignored this entry's existence, with subsequent Larry games returning to the series' adventure game roots[^ref-55]. The game stands as a stark reminder of how celebrity voice acting and high production values cannot salvage fundamentally flawed game design and technical execution.

## Downloads

**Purchase / Digital Stores**
- Not currently available on major digital platforms[^ref-58]
...
- **Previous:** [[2004 - Leisure Suit Larry - Magna Cum Laude]] (Larry Lovage storyline)
- **Next:** [[2018 - Leisure Suit Larry - Wet Dreams Don't Dry]] (Larry Laffer returns)
