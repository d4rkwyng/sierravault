...
tags: [1980s, adventure, al-lowe, leisure-suit-larry, sci, sierra]
---
...
*Leisure Suit Larry Goes Looking for Love (in Several Wrong Places)* is the second game in [[Al Lowe]]'s landmark comedy adventure series, released by Sierra On-Line in October 1988.[^ref-1] The sequel marked a significant technical leap forward, being one of the first games to utilize Sierra's new Creative Interpreter (SCI) engine, which introduced full-screen graphics, mouse control for movement, and support for sound cards—features that would define Sierra's adventure games throughout the early 1990s.[^ref-2] "For better or worse, Larry Laffer is among the most recognized cult heroes in adventure games," noted Adventure Classic Gaming's retrospective review.[^ref-3]

Unlike its predecessor, which faced retailer resistance due to its perceived adult content, the sequel deliberately toned down the sexual humor in favor of a more elaborate plot involving espionage, tropical islands, and globe-trotting adventure.[^ref-26] This shift was a direct response to commercial pressures—"A Leisure Suit Larry sequel was not always a sure thing… Setting aside the fact that a number of retailers refused to sell the game based on its perceived content, initial sales were some of the lowest in Sierra's history."[^ref-5] The gamble paid off: the game eventually sold over 250,000 copies and helped establish the series as a commercial powerhouse.[^ref-6]

The game is three times longer than the original, featuring approximately 75 unique locations compared to the first game's more modest scope.[^ref-3][^ref-7] However, this expansion came with a controversial design decision: the game actively punishes Larry for flirting with any woman he meets, invariably leading to his violent death—a marked departure from the series' central premise.[^ref-8] "This lack of Leisure Suit Larry's trademark humor was an oft-cited criticism of the game and the series returned to its original formula in all later games."[^ref-9]

> [!info]- Game Info
> **Developer:** [[Sierra On-Line]][^ref-1]
> **Designer:** [[Al Lowe]][^ref-1]
> **Publisher:** Sierra On-Line[^ref-1]
> **Engine:** SCI0 (Sierra's Creative Interpreter)[^ref-2]
> **Platforms:** MS-DOS, Amiga, Atari ST, Windows[^ref-1]
> **Release Year:** 1988
> **Series:** Leisure Suit Larry
> **Protagonist:** Larry Laffer
...
The game opens with Larry Laffer discovering that his romantic triumph from the first game was nothing more than a fleeting encounter. "We find our hero, Larry Laffer, mowing Eve's lawn (not like that!) as Eve pulls up and screams at Larry to leave (and that, what he thought was true love, turns out to only be a one night stand – one, that Eve barely even remembers!)"[^ref-10] Cast out into the streets of Los Angeles, penniless and womanless, Larry's luck suddenly takes an unexpected turn.[^ref-11]

After being dumped by Eve, Larry finds his fortune steadily improving as he wins the lottery, a blind date contest, and a vacation on a cruise ship.[^ref-12] However, Larry unwittingly becomes entangled in international intrigue when he accidentally comes into possession of a Peruvian "onklunk"—a mysterious instrument containing microfilm sought by KGB agents.[^ref-13] The language barrier between Larry and the woman at the music store means he has no idea of the significance of what he's carrying or that he's being pursued by dangerous operatives.[^ref-1]
...
The game utilizes Sierra's newly developed SCI0 engine, representing a significant advancement over the AGI engine used in the original game.[^ref-2] "LSL2 is more advanced than the original, due to the use of Sierra's new SCI engine which boasts a higher resolution, fancier graphics, mouse support, and support for common sound cards of the time."[^ref-1] Players control Larry using a mouse-based interface for movement while retaining the text parser for interactions and commands.[^ref-16]

The technical presentation runs at 320x200 resolution in 16-color EGA graphics, a notable improvement over the original's more limited visuals.[^ref-2] "Larry now consists of at least eight pixels," joked one reviewer about the graphical upgrade.[^ref-17] The game was among the first to support FM synthesis and Roland MT-32 sound cards, with Al Lowe composing the soundtrack himself.[^ref-18]

### Structure and Progression

Unlike the original's more open-ended design, the sequel follows a linear story progression similar to Sierra's other adventure games, particularly later entries in the King's Quest series.[^ref-8] The game takes Larry through several distinct areas:
...
There are fewer puzzles in this installment than in the previous game; however, the number of ways to die has increased dramatically, with danger awaiting Larry in most places he visits.[^ref-16] A YouTube compilation of death scenes reportedly runs approximately 40 minutes.[^ref-7] The game's inventory system is accessed via Ctrl+I, and points are awarded for completing puzzles and discovering secrets, with rank changes occurring at score milestones.[^ref-20]
...
The existence of a sequel was far from guaranteed. The original *Leisure Suit Larry in the Land of the Lounge Lizards* faced significant challenges at retail—"a number of retailers refused to sell the game based on its perceived content" and "initial sales were some of the lowest in Sierra's history."[^ref-5] The game sold only 4,000 copies in its first month, growing significantly only after word of mouth spread.[^ref-23] Remarkably, Sierra sold more hint books than actual games due to rampant piracy.[^ref-23]

Al Lowe faced pressure to clean up Larry's act for the sequel. "After the original was claimed to be too dirty by some, Al Lowe decided to make Larry go looking for true love, as opposed to cheap sex (as stated in the manual of the collection)."[^ref-28] Ironically, the same retailers who complained the first game was "Too dirty" later complained that this one was "Too clean."[^ref-26]
...
One unexpected result of the development cycle was Josh Mandel's hiring by Sierra—he won Sierra's CompuServe "Trite Phrase" competition with the entry "Do you want fries with that?" and was subsequently brought on staff.[^ref-1]
...
**MS-DOS Version:**[^ref-27]
- **Resolution:** 320x200, 16 colors (EGA)
- **Audio:** PC Speaker, AdLib, Roland MT-32, Game Blaster
- **Media:** Six 3.5" or 5.25" floppy disks
- **Video Modes Supported:** Hercules, Tandy/PCjr, CGA, EGA (MCGA/VGA in 16-color compatibility mode)[^ref-31]

**2017 Steam Re-release:**[^ref-27]
...
The game's ending was originally planned to give players more control during the climactic sequences, but shipping deadlines forced Al Lowe to implement an "auto pilot" ending with minimal interactivity.[^ref-1] The time and floppy disk space constraints meant the final area became largely a non-interactive cutscene.[^ref-29]
...
Despite initial struggles at retail due to its predecessor's controversial reputation, the game eventually sold over 250,000 copies.[^ref-6] The entire Larry series surpassed 1.4 million units by March 1996, and the first five Larry games exceeded 2 million copies by the launch of *Love for Sail!*[^ref-6] The game "became a commercial success several months later and was widely pirated."[^ref-7]
...
- **Larry's Little Black Book:** Included with the game as copy protection; featured intentionally low-quality photos of women with phone numbers to be referenced during startup[^ref-3]
- **The Official Book of Leisure Suit Larry:** Contains Al Lowe's advice including the famous "Save early and often!" guidance[^ref-22]
- **Game Manual:** Eight-page instruction booklet covering interface, commands, and gameplay basics[^ref-39]
...
- [Internet Archive](https://archive.org/details/msdos_Leisure_Suit_Larry_2_-_Goes_looking_for_Love_in_Several_Wrong_Places_1988) – Playable in browser[^ref-11]
- [MyAbandonware](https://www.myabandonware.com/game/leisure-suit-larry-goes-looking-for-love-in-several-wrong-places-h5) – DOS, Amiga, Atari ST versions[^ref-26]
- [ClassicReload](https://classicreload.com/leisure-suit-larry-goes-looking-for-love-in-several-wrong-places.html) – Browser emulation[^ref-8]
...
Leisure Suit Larry Goes Looking for Love (in Several Wrong Places) builds upon the foundation established by its predecessor, Leisure Suit Larry in the Land of the Lounge Lizards, by introducing significant technical advancements and a shift in narrative focus. The game's utilization of Sierra's Creative Interpreter (SCI) engine marked a major leap forward, offering full-screen graphics, mouse control, and sound card support that would become hallmarks of Sierra's adventure games. This sequel also toned down the sexual humor present in the first game, opting for a more elaborate plot involving espionage and globe-trotting adventure.

The story of Leisure Suit Larry Goes Looking for Love (in Several Wrong Places) sees Larry Laffer once again on a quest for love, but this time his journey is complicated by international intrigue and his unwitting possession of a valuable microfilm. As Larry navigates through various locations, from Los Angeles to a tropical island, he encounters numerous characters who aid or hinder his progress, including the femme fatales who are central to the plot's twists and turns. The game's conclusion sets the stage for the next installment in the series, Leisure Suit Larry III - Passionate Patti in Pursuit of the Pulsating Pectorals, by introducing key characters such as Kalalau, later known as Polyester Patti or Passionate Patti.

Mechanically, Leisure Suit Larry Goes Looking for Love (in Several Wrong Places) laid the groundwork for future games in the series, including Leisure Suit Larry III - Passionate Patti in Pursuit of the Pulsating Pectorals, by refining the SCI engine and introducing features like mouse-based movement and improved graphics. The game's design decisions, such as punishing Larry for flirting with women, were later revisited in favor of returning to the series' trademark humor. Overall, Leisure Suit Larry Goes Looking for Love (in Several Wrong Places) serves as a pivotal entry in the Leisure Suit Larry series, bridging the gap between the original game's straightforward premise and the more complex narratives that would follow.
