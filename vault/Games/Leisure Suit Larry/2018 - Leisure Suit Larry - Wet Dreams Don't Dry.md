...
genre: Adventure
platforms: [PC, PlayStation 4, Nintendo Switch, Xbox One, Mac, Linux]
...
> **Designer:** Falko Löffler, Heiner Schmidt, Malte Schmidt, Maurice Alain Hagelstein, Svenja Borchert[^ref-8]
> **Publisher:** [[Assemble Entertainment]][^ref-2]
> **Platforms:** PC, PlayStation 4, Nintendo Switch, Xbox One, Mac, Linux[^ref-5]
> **Release Year:** 2018
> **Series:** Leisure Suit Larry
...
Wet Dreams Don't Dry returns to the classic point-and-click adventure format that made the original series famous[^ref-11]. The game features modern conveniences while maintaining traditional adventure game mechanics, including inventory management, dialogue trees, and environmental puzzles[^ref-12]. Central to the experience is Larry's smartphone, which serves as both a gameplay mechanic and narrative device for accessing social media parodies like "Instacrap" (Instagram) and "Farcebook" (Facebook)[^ref-13].

The interface incorporates over 100 items to find throughout the adventure, leading to "very strange ways that they need to be used and/or combined"[^ref-14]. Players navigate through beautifully hand-drawn locations using standard adventure game controls, clicking to interact with objects and characters[^ref-15].

### Structure and Progression

The game is structured around Larry's quest to achieve a perfect Timber rating of 90 points[^ref-9]. This central objective drives the player through various locations in New Lost Wages, each presenting unique challenges and characters[^ref-16]. The adventure spans approximately 8-10 hours of gameplay[^ref-17] across over 30 hand-drawn venues and featuring more than 30 unique characters[^ref-14].

Progress is tracked through Larry's smartphone interface, with story elements delivered through Instagram-style posts in the fictional Instacrap app[^ref-3]. The game includes 31 Steam achievements for completionist players[^ref-18], though notably lacks autosave functionality and chapter select options[^ref-19].

### Puzzles and Mechanics

The puzzle design follows traditional adventure game logic, though some critics noted that "many descend into the realm of frustratingly nonsensical, requiring seemingly endless trial and error"[^ref-20]. The game includes both inventory-based puzzles and social interaction challenges related to the dating app mechanics[^ref-21]. One section allows players to experience Larry's past in "eight-bit glory," serving as both a gameplay mechanic and nostalgic callback to the series' origins[^ref-22].
...
|-------------|-------|-------|
| Ragequit.gr | 95/100 | "Extraordinary puzzle design and brilliant writing"[^ref-23] |
| PC Games | 82/100 | "Keeps the charm and humor of the first games"[^ref-23] |
| Adventure Gamers | 80/100 | "Excellent addition to the Larry brand"[^ref-23] |
| Destructoid | 70/100 | "Solid and definitely has an audience"[^ref-6] |
| Screen Rant | 6/10 | "A bit of fun, most at Larry's expense"[^ref-13] |
| Gaming Respawn | 5/10 | "Feels like a relic of what gaming used to be"[^ref-15] |
...
The project began when German developer CrazyBunch acquired the rights to the Leisure Suit Larry franchise[^ref-24]. The development team described themselves as "fans of the classic Sierra and Lucasarts adventure games" who hoped "to deliver something that lives up to that legacy"[^ref-14]. The decision to create a direct sequel to the first Leisure Suit Larry game while ignoring more recent entries was deliberate, effectively retconning Magna Cum Laude and Box Office Bust[^ref-21].

Notably absent from development was series creator Al Lowe, who "only found out about the game when it was first announced to the public in May 2018, six months before the game's release"[^ref-7]. Lowe expressed his feelings about the project's title, stating: "if that title is the best they could come with, I'm glad I'm not" involved[^ref-25].

### Production

The game was developed using Unity engine (specifically build 2017.4.29f1)[^ref-26] with a team of 61 people credited, including 33 developers and 28 acknowledgments[^ref-8]. The project was partially funded by a Creative Europe MEDIA grant[^ref-2], enabling the creation of over 50 hand-drawn locations[^ref-27].

Voice acting saw the return of Jan Rabson as Larry Laffer[^ref-12], though the original voice actor was recast due to fan backlash after the first trailer, despite having already recorded 25% of the dialogue[^ref-7]. The soundtrack was composed by Johannes Semm and Kai Rosenkranz[^ref-28], with the complete soundtrack available through various digital music platforms[^ref-29].

### Technical Achievements

The game was built on Unity 2017 and featured cross-platform compatibility across PC, PlayStation 4, Nintendo Switch, and Xbox One[^ref-30]. Technical documentation reveals comprehensive PC gaming compatibility information including system requirements for Windows 7, 8, 10, and 11[^ref-26]. Post-release support included patches rolled out differently between Steam and GOG.com platforms, with Steam typically receiving updates first[^ref-31].

A significant post-launch update called the "Happy Ending Update" was released in late 2019 following fan feedback about the original ending's abruptness[^ref-32]. This content served as an epilogue expanding upon Larry's misadventures and providing closure to the Faith storyline[^ref-32].

## Legacy

Wet Dreams Don't Dry successfully revitalized the dormant Leisure Suit Larry franchise after more than a decade of absence from traditional adventure gaming[^ref-33]. The game's success led directly to a sequel, "Leisure Suit Larry: Wet Dreams Dry Twice," released in October 2020[^ref-34]. Critics and fans generally agreed that despite its flaws, the game "got much closer to the classic games in terms of story, humor, and gameplay than the rather lackluster Magna Cum Laude and Box Office Bust"[^ref-35].
...
- **Next:** [[2020 - Leisure Suit Larry - Wet Dreams Dry Twice]]
