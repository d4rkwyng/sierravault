...
- Instead, it used a "verb bar" window along the bottom of the screen, similar to LucasArts' SCUMM engine[^ref-3][^ref-15]
- The point-and-click interface includes icons for walking, looking, using/taking objects, and talking[^ref-6]
...
- Some puzzle solutions required information that was supposed to be in a magazine but was put into the manual instead[^ref-3][^ref-17]
- The game requires an included magazine to complete certain puzzles[^ref-5]
- The Datacorder puzzle originally had hints in a comic book CD that was cut from the final game[^ref-17]
...
- **Josh Mandel tribute:** Same process but press Games button instead of Movies[^ref-24]
- **Stooge Fighter III birthday names:** Playing on programmers' birthdays changes the stooges' names—Michael Lytton (April 11), Steve Conrad (January 3), William Shockley (December 29)[^ref-24]
- **Halloween 8-Rear:** Enter 8-Rear on October 31st or Michael Lytton's birthday for special content[^ref-24]
- **Falling spider:** In Orion's Belt basement, click the HAND icon on the spider on the far-left pipe—it falls screaming to the floor (once per game only)[^ref-25]
- **Jockstrap ship controversy:** Marketing wanted the DeepShip 86 changed to a "normal" ship; Josh and Scott ignored them, and the first ad prominently featured the jockstrap design[^ref-25]
- **LSL6 BFD insignia:** The DeepShip 86 insignia includes "LSL6 BFD" in small text—"Leisure Suit Larry 6: Big Fucking Deal"[^ref-25]
...
### Cameo Appearances
- **Gabriel Norton poster:** A sewer worker who doubles as a psychic investigator—parody of Gabriel Knight[^ref-27]
- **SQ4 centerfold alien:** The alien lounging on a time pod is the same "babe" from the Space Piston centerfold in Space Quest IV[^ref-27]
- **Shuttle bay parodies:** Alien dropship (bottom right), Star Trek shuttle with NCC-1701D insignia (middle left), Battlestar Galactica ship (upper left), Thunderbirds "Shuttle 2" (bottom right red), Star Wars shuttle (left)[^ref-27]
- **Storm Poopers:** When escaping in the StarCon shuttle, "Storm Poopers" (relabeled Storm Troopers) crawl out to stop Roger, mimicking the Millennium Falcon escape[^ref-27]
- **Pelvis Brelsford poster:** Elvis poster in Nigel and Singent's apartment relabeled as "Pelvis Brelsford - The Rock'n'Roll Programming Sensation"—a joke at Project Manager Oliver Brelsford's expense[^ref-27]

### Pop Culture References
- **Wayne's World:** Looking at a shuttle triggers Roger to say "It will be mine, oh yes, it will be mine"[^ref-28]
- **Robocop:** Talking to the shuttle makes Roger say "I'd buy that for a dollar"[^ref-28]
...
- **Cigar stump paradox:** Roger discards the cigar stump in SQ4's Super Computer and never retrieves it, yet it appears on his table in SQ6 as a "souvenir"[^ref-30]
- **Holo-chaplain transport:** The chaplain at Stellar's funeral is described as a "hologram" but leaves via the pneumatic transport system—impossible for a hologram[^ref-30]
...
- Best of Sierra Nr.4 (German release)[^ref-2]

## Downloads

**Purchase / Digital Stores**

- [GOG – Space Quest 4+5+6](https://www.gog.com/en/game/space_quest_4_5_6)[^ref-7]
...
- [Space Quest 6 Manual](https://wiw.org/~jess/publications/sq6manual.pdf) (PDF)[^ref-20]
- [Popular Janitronics Magazine](https://wiw.org/~jess/publications/janitronics.pdf) – pack-in feelie (PDF)[^ref-20]
- [Space Quest 6 Quick Start Guide](https://wiw.org/~jess/publications/sq6_quick_start_guide.pdf) (PDF)[^ref-20]
- [Official Player's Guide – Space Quest 6](https://wiw.org/~jess/publications/sq6guide.pdf) (PDF)[^ref-20]
- [Sierra Chest – Space Quest 6](https://www.sierrachest.com/index.php?a=games&id=14&title=space-quest-6&fld=general) – walkthrough, maps, easter eggs, memorabilia[^ref-2]
- [MobyGames – Space Quest 6](https://www.mobygames.com/game/145/space-quest-6-roger-wilco-in-the-spinal-frontier/) – covers, screenshots, credits[^ref-6]
- [Wikipedia – Space Quest 6](https://en.wikipedia.org/wiki/Space_Quest_6) – encyclopedia article[^ref-1]
- [PCGamingWiki – Space Quest 6](https://www.pcgamingwiki.com/wiki/Space_Quest_6%3A_Roger_Wilco_in_The_Spinal_Frontier) – technical fixes[^ref-5]
...
[^ref-20]: [Virtual Broomcloset – Publications Archive](https://wiw.org/~jess/publications.html) – manuals, hint books, pack-in feelies
[^ref-21]: [Wikipedia – Space Quest: Vohaul Strikes Back](https://en.wikipedia.org/wiki/Space_Quest:_Vohaul_Strikes_Back) – fan sequel development, reception, awards
[^ref-22]: [Computer Gaming World – October 1995 (Issue 135)](https://archive.org/details/Computer_Gaming_World_Issue_135) – Charles Ardai review pp. 170-172: "graphics are better than in any previous Space Quest", "Gary Owens contributes his inimitable narration"
[^ref-23]: [SEC Filing – Sierra On-Line 10-K (March 1996)](https://web.archive.org/web/20180416004925/https://www.sec.gov/Archives/edgar/data/724991/0000891020-96-000721.txt) – "sold more than 1.2 million copies" for Space Quest series
[^ref-24]: [SpaceQuest.net – SQ6 Easter Eggs](https://spacequest.net/sq6/eastereggs/) – shuttle movie/games menu, Josh Mandel tribute, Stooge Fighter birthday names, Halloween 8-Rear
[^ref-25]: [SpaceQuest.net – SQ6 Fun Facts](https://spacequest.net/sq6/funfacts/) – Janitalia magazine name, KQ6 genie music, spider easter egg, jockstrap ship controversy, LSL6 BFD insignia
