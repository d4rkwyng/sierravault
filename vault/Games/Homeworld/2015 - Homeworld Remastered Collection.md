...
designer: [Alex Garden, Erin Daly]
...
The series continued with Homeworld: Deserts of Kharak (2016), a prequel developed by Blackbird Interactive that explores events on Kharak before the exodus[^ref-63]. The main character Rachel S'jet is an ancestor of Karan S'jet[^ref-63]. Homeworld 3 released May 13, 2024, decades after the events of Homeworld 2[^ref-33].

A mobile entry, Homeworld Mobile, launched October 11, 2022, set over a century after the original game's storyline[^ref-64], though its servers were shut down on July 29, 2024[^ref-65].
