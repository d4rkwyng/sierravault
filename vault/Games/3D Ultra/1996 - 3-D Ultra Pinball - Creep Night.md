---
title: '3-D Ultra Pinball: Creep Night'
release_year: 1996
developer: Dynamix
designer: []
publisher: Sierra On-Line
genre: Pinball
platforms: [DOS, Windows, Mac OS, Windows 3.x]
...
> **Designer:** Unknown[^ref-1]
> **Publisher:** [[Sierra On-Line]][^ref-1]
> **Platforms:** Windows, Mac OS, DOS, Windows 3.x[^ref-5]
> **Release Year:** 1996
> **Series:** 3-D Ultra Pinball
...
3-D Ultra Pinball: Creep Night doesn't follow a traditional narrative structure but instead creates atmosphere through its gothic horror theme. The game takes players through a haunted castle environment featuring three distinct areas: the Castle grounds, the Tower top, and the Dungeon depths[^ref-4]. Each table presents a mission-based concept with five tasks per table that players must complete[^ref-4]. The horror theme is reinforced through animated creatures and supernatural elements that would be impossible to achieve in a real pinball machine[^ref-2].

## Gameplay

### Interface and Controls

Creep Night utilizes standard pinball controls adapted for computer play, with players controlling flippers to keep the ball in play while attempting to complete various objectives[^ref-4]. The game offers "a belfry of configurable preferences, multiple skill-level adjustments, and a brood of toggleable detail options" that make it "one of the most adaptable pinball games to scare up attention"[^ref-1]. Players praised the game's 3D sound effects, with one noting that "the first pinball to use 3D effects has a sound system that helps to evolve you with the game"[^ref-6].

### Structure and Progression

The game is structured around three main tables arranged in what sources describe as "3 smaller tables arranged horizontally"[^ref-2]. Each table represents a different area of the haunted castle theme, and players work through mission-based objectives with five tasks per table[^ref-4]. A hidden fourth table lurks somewhere in the game, providing additional content for dedicated players[^ref-2][^ref-4]. The progression system rewards players for completing specific objectives rather than simply achieving high scores, distinguishing it from more traditional pinball games.

### Puzzles and Mechanics

While not featuring traditional adventure game puzzles, Creep Night incorporates animated elements and special events that trigger based on ball placement and timing. The game takes advantage of its video format to include "things that would be impossible on a physical pinball table"[^ref-2], such as animated creatures that interact with the ball and special effects sequences. However, the physics were criticized as unrealistic, with the ball frequently gravitating "towards points of no return" and players experiencing "frequent losses to outlane or untouchable space between flippers"[^ref-4].
...
|-------------|-------|-------|
| GameRevolution | 7/10 | Released November 5, 1996[^ref-1] |
| Joystick | 80% (PC), 60% (Mac) | Notable platform disparity[^ref-1] |
| Gamezilla | 88% | Reviewed by Bob Mandel[^ref-1] |
| PC Multimedia & Entertainment | 88% | "Right balance of excellent sights and sounds"[^ref-1] |
| PC Games (DE) | 68% | German publication[^ref-1] |
| PC Joker | 74% | September 20, 1996[^ref-1] |
| MacUser | 3/5 | Roman Loyola, March 1997[^ref-1] |
| PC Player | 4 stars | Monica Stoscheck[^ref-1] |
| Score | 3/10 | Notably negative outlier[^ref-1] |

Computer Gaming World's Charlotte Panther concluded that "Creep Night is an entertaining game with plenty of scope for replayability"[^ref-1][^ref-3]. Mac Game Gate's Robert Edvardsson called it "one of the finest pinball simulators available for the Mac," praising its sound effects, music, and graphics[^ref-1]. PC Multimedia & Entertainment awarded it 88%, stating that "Creepnight offers the right balance of excellent sights and sounds, with non-stop addictively compelling gameplay!"[^ref-1]
...
3-D Ultra Pinball: Creep Night was developed by Dynamix for Sierra On-Line as the second entry in the 3-D Ultra Pinball series[^ref-1][^ref-4]. The series built upon the success of the original 3-D Ultra Pinball, which was inspired by Sierra's 1994 title Outpost[^ref-3]. Development was handled by Jeff Tunnell Productions/Dynamix, continuing Sierra's strategy of expanding into casual gaming markets during the mid-1990s[^ref-3].

### Production

The game was released simultaneously for Windows and Mac OS platforms in 1996[^ref-1], with additional releases following in 1997 and a German re-release in 2005[^ref-5]. The production featured 3D rendered graphics for the pinball table and animations, representing cutting-edge technology for pinball games of the era[^ref-6]. A Portuguese version was also created that included multiple language options[^ref-7].
...
- Available through various retro gaming vendors[^ref-2]
- Listed on GOG community wishlist[^ref-9]

**Download / Preservation**
- [My Abandonware](https://www.myabandonware.com/game/3-d-ultra-pinball-creep-night-3fh) - Full game download with modern compatibility notes[^ref-5]
- [Internet Archive - Original 1996 Release](https://archive.org/details/3-D_Ultra_Pinball_Creep_Night_Sierra_1996) - Preserved original version[^ref-10]
- [Internet Archive - Portuguese Version](https://archive.org/details/3-d-ultra-pinball-creep-night-pt-pt) - Multi-language release[^ref-7]
- [Collection Chamber Blog](https://collectionchamber.blogspot.com/p/3d-ultra-pinball-2-creep-night.html) - DOSBox-compatible version[^ref-4]
...
[^ref-2]: [All Video Classic Games - 3D Ultra Pinball: Creep Night](https://www.allvideoclassicgames.com/products/3d-ultra-pinball-creep-night-1clk-windows-10-8-7-vista-xp-install) - Commercial product listing with detailed game description and technical features
[^ref-3]: [Retro365 Blog - 3-D Ultra Pinball: Revitalizing a Classic Game](https://retro365.blog/2025/02/16/3-d-ultra-pinball-revitalizing-a-classic-game-in-the-multimedia-age/) - Historical overview and sales figures
[^ref-4]: [The Collection Chamber - 3D Ultra Pinball 2: Creep Night](https://collectionchamber.blogspot.com/p/3d-ultra-pinball-2-creep-night.html) - Retro gaming preservation blog with gameplay analysis
[^ref-5]: [My Abandonware - 3-D Ultra Pinball: Creep Night](https://www.myabandonware.com/game/3-d-ultra-pinball-creep-night-3fh) - User reviews and technical compatibility information
[^ref-6]: [GameSpot User Reviews - 3D Ultra Pinball: Creep Night](https://www.gamespot.com/3d-ultra-pinball-creep-night/user-reviews/2200-136421/) - User review compilation with ratings from 2004-2006
[^ref-7]: [Internet Archive - 3-D Ultra Pinball: Creep Night PT-PT](https://archive.org/details/3-d-ultra-pinball-creep-night-pt-pt) - Archive preservation page with Portuguese version metadata
