---
title: 3-D Ultra Mini Golf Deluxe
release_year: 1998
developer: Dynamix
designer: [Dynamix, Jeff Tunnell]
publisher: Sierra On-Line
genre: Sports
platforms: [Windows, PC, DOS, Windows 95, Windows 10, Windows 11]
series: 3D Ultra
...
> **Designer:** Dynamix[^ref-7]
> **Publisher:** [[Sierra On-Line]][^ref-7]
> **Platforms:** Windows, PC, DOS, Windows 95[^ref-3][^ref-5][^ref-10][^ref-14]
...
The game offers two distinct control methods for putting. The traditional "EasyPutt" style provides standard golf game controls, while "TruePutt" attempts more realistic physics simulation. However, reviews note that "TruePutt is far trickier to control... It is also incredibly inconsistent, betraying its namesake. There's a reason why the EasyPutt style is still around in golf games to this day and TruePutt is lost to time"[^ref-3]. The game's interface is described as having "3D graphics are pretty cool and the gameplay is simple, controlled by intuitive mouse movements"[^ref-4].

### Structure and Progression

The Deluxe version contains 27 holes total across multiple courses, combining the original 18 holes with 9 additional holes[^ref-7]. The game supports "up to four players can play in both hotseat and online play" and "features traditional scored, hole-by-hole and race play modes"[^ref-2]. Players can enjoy "there are often multiple ways to get to the hole, and usually a shortcut or two in each level - some hidden, some not" with "special animations that play when you beat a course with a hole-in-one"[^ref-27].

### Puzzles and Mechanics

The courses feature fantastical elements beyond traditional miniature golf. The Sierra Chest walkthrough reveals complex hole designs, noting for one course: "Took a long time to figure this one out. If the ball drops into the teleporter in the center, you will not get a hole-in-one, but just get close to the hole"[^ref-23]. Another hole is described as having a "more direct approach" than "most people try to go the long way around"[^ref-23], while one course is characterized as "a rather long and boring course"[^ref-23]. The game includes "hidden holes" as easter eggs[^ref-20] and uses "pre-rendered CGI static screenshots for hole graphics"[^ref-3].

## Reception

### Contemporary Reviews

The game received mixed reviews across different platforms and time periods. User ratings were generally positive, with MyAbandonware users giving it 4.59/5[^ref-19] and 4.36/5[^ref-20] respectively. CNET Download users rated it 3.2/5[^ref-4]. An enthusiastic user review from 2010 gave the game 9/10, noting "If you're looking for a fun and wacky minigolf game, this one is for you!" and highlighting that "what makes the really shine trough are the announcers!"[^ref-16]

| Publication | Score | Notes |
|-------------|-------|-------|
| CNET Download | 3.2/5 | User ratings spanning 2000-2005[^ref-4] |
| MyAbandonware | 4.59/5 | User rating[^ref-19] |
| MyAbandonware | 4.36/5 | Alternative user rating[^ref-20] |
| sb1254 (Forum) | 9/10 | "This is a gem of a game with fun holes, great gameplay, and lots of replayability"[^ref-16] |
...
3-D Ultra Mini Golf Deluxe was developed by Dynamix[^ref-2] and published by Sierra On-Line in July 1998[^ref-7]. The game was part of Sierra's 3D Ultra series, being "in the same series as 3-D Ultra Pinball" but representing the "first non-pinball entry in 3D Ultra series"[^ref-3]. The original 3-D Ultra Minigolf was released in May 1997[^ref-1], with the Deluxe version following as a direct sequel that added content rather than changing core mechanics.

### Production

The development was handled by Dynamix, Sierra's internal development studio known for acclaimed titles like Tribes and The Incredible Machine[^ref-12]. The game's production involved creating "pre-rendered CGI static screenshots for hole graphics"[^ref-3] and implementing two different putting control systems. A version 1.01 patch was later released that "added online play capability"[^ref-6], expanding the multiplayer functionality beyond local hotseat play.

Tragically, "Dynamix division was closed by Sierra in 2001 during development of next minigolf game"[^ref-1], which affected the series' future development. The planned sequel "Minigolf Maniacs" for PC and PlayStation 2 "went unreleased for five years until Wanako Studios completed development of the game in 2006" as 3D Ultra Minigolf Adventures[^ref-8].

### Technical Achievements

The game ran on Windows 95 and later systems[^ref-4], with file sizes of "611 Mb (Version 1) / 571 Mb (Version 2)" and install sizes of "836 Mb (Version 1) / 660 Mb (Version 2)"[^ref-3]. The technical specifications included support for Windows 95 as the minimum requirement[^ref-4]. The game featured "true-to-life ball dynamics and different surface types"[^ref-1] and offered both local and online multiplayer capabilities after the 1.01 patch[^ref-6].
...
- [Steam - 3D Ultra Minigolf Adventures](https://store.steampowered.com/app/10140/3D_Ultra_Minigolf_Adventures/) - €9.99[^ref-26]

**Download / Preservation**
- [MyAbandonware - 3-D Ultra Minigolf Deluxe](https://www.myabandonware.com/game/3-d-ultra-minigolf-deluxe-duw)[^ref-19]
- [Internet Archive - 3D Ultra Minigolf Deluxe](https://archive.org/details/3DUltraMinigolfDeluxe_201809)[^ref-2]
...
[^ref-2]: [Internet Archive - 3D Ultra Minigolf Deluxe](https://archive.org/details/3DUltraMinigolfDeluxe_201809) – - Basic game metadata and release information
...
[^ref-22]: [Sierra Chest - Game Information](https://www.sierrachest.com/index.php?a=games&id=108) – - Fan archival website with game history
[^ref-23]: [Sierra Chest - Minigolf Adventures Deluxe](https://sierrachest.com/index.php?a=games&id=344&title=minigolf-adventures-deluxe&fld=general) – - Development history and technical specifications
[^ref-24]: [Steam Community - Game Page](https://steamcommunity.com/app/10140) – - User discussions and technical issues
