...
designer: [Daryl F. Gates, Tammy Dargan]
...
The game's scoring system was based entirely on following standard operating procedures correctly[^ref-11]. Players received feedback when they deviated from proper police protocol, with messages like "Deadly use of force was not tactically correct!" appearing when inappropriate actions were taken[^ref-12]. This realistic approach meant that "the sheer level of realism in this game is groundbreaking, if not a bit annoying at times"[^ref-13].

The investigation took players through multiple floors of Parker Center (LAPD headquarters), which were recreated in the game with meticulous detail[^ref-14]. Chief Gates wanted to keep the game as realistic as possible and insisted on using actual LA locations[^ref-15]. Sierra gained cooperation from LAPD and mayor's office through Gates' involvement, allowing photography of authentic locations including Parker Center, county morgue, civic center, and police academy[^ref-16].

### Puzzles and Mechanics

The game featured complex investigative puzzles that required proper evidence collection and police procedure. Player choices throughout the game could lead to different outcomes, adding replay value and depth to the experience[^ref-3]. However, as one critic noted, "The main problem with all the Police Quest games is that if you miss a event or a item you will get hung up and have no way to complete the game"[^ref-17].

The realistic approach extended to character interactions and dialogue. As Daryl Gates explained in a 1994 Vibe magazine interview about advising Sierra writers: "I told them that these people people use the same language as you and I"[^ref-12], though Sierra's writers included stereotypical dialogue despite Gates advising against it[^ref-18].
...
|-------------|-------|-------|
| MobyGames Critics | 73% | [^ref-19] |
| GameSpot User Reviews | 6.8/10 | [^ref-17] |
| IMDb | 6.7/10 | [^ref-20] |
| My Abandonware | 4.43/5 | [^ref-21] |
| Abandonware DOS | 4.21/5.00 | 85 votes[^ref-1] |
| Just Games Retro | 4/10 average | 2 total votes[^ref-22] |

The mature subject matter and photo-realistic graphics resulted in an MA-17 listing from the ESRB rating system when it was established in 1994.[^ref-47]

### Modern Assessment

Modern retrospective reviews have been largely critical of the game. Adventure Gamers gave it only 2 stars, concluding that "there are some good elements that shine through occasionally, but generally the game is not a positive experience"[^ref-23]. The review criticized the "voice acting Ed Wood would love" and noted that "with a conclusion that borders on incomprehensible, Police Quest 4 offers impressive technological advances from previous games in the series, but loses their simpler charms"[^ref-23].

Alex Bevilacqua was even harsher in his 2024 retrospective, giving the game 40% and stating "The graphics are blocky and just overall look shitty" and "Sierra should have left this series alone after Police Quest 3"[^ref-24]. Space Quest Historian described the game as a "depressingly goofy trainwreck" with "mushy, pixelated" graphics and an "absolute slog" of gameplay[^ref-25].

However, some reviewers found merit in the game's ambitious approach. One MobyGames user noted that it was "very much ahead of its time. It attempts to provide an interactive and realistic experience as to what a police detective actually does during a murder investigation. This is years before, 'Grand Theft Auto' would attempt a similar interactive and realistic experience"[^ref-26].

## Development

### Origins

The game's development began after Jim Walls, creator of the original Police Quest series, left Sierra. As Walls explained on his personal website: "after PQ 3, circumstances developed causing me to decide it was time that I leave"[^ref-27]. Ken Williams wanted the police games to transition into tactical simulations more than just being interactive stories, leading him to seek out Daryl Gates, who had knowledge of police procedures and tactics that were well beyond what any one field officer could bring to the table[^ref-14].

Former LA Police Chief Daryl F. Gates joined the Sierra team to show gamers the true face of police work[^ref-28]. Gates, who had recently resigned following the 1992 LA riots, served primarily as a technical advisor rather than the actual designer[^ref-29]. The real creative force behind the game was Tammy Dargan, a former producer on the TV show America's Most Wanted, who served as producer, director, designer, and writer[^ref-29].
...
Police Quest: Open Season was the first game to use Sierra's SCI2 engine[^ref-35] and represented a major technological leap forward. It was the first Sierra game to feature photo-realistic backgrounds, long before the likes of Phantasmagoria and its sequel[^ref-36]. The team used photoshots of real L.A. exteriors and interiors, motion capture technology, and different voice actors from motion capture actors[^ref-37].

The game came with a 54-page abridged version of the actual LAPD operations handbook[^ref-38], which contained detailed regulations such as "the prescribed trousers belt shall be worn under the Police Equipment Belt. It shall be adjusted so that no part other than the top edge is visible"[^ref-14]. This manual served as both a reference guide and an attempt to add authenticity to the gaming experience.

### Voice Cast

The CD-ROM version featured extensive voice acting with over 10,000 lines of dialogue.[^ref-34] Several Sierra employees also appeared as actors in the game.[^ref-8]

**Principal Cast:**[^ref-20][^ref-46]
...
| Digital | 2011 | Windows | GOG.com release as part of Police Quest Collection[^ref-40] |

## Legacy

Police Quest: Open Season marked the end of the traditional Police Quest adventure game series, though the franchise would continue with the SWAT tactical series[^ref-38]. By 1995, the first four Police Quest games had sold a combined 850,000 copies[^ref-47]. The game's attempt to blend serious police simulation with adventure gaming was ambitious but ultimately unsuccessful in winning over critics and fans of the original series.

Despite its critical reception, the game's technological innovations were significant. As PC Gamer's Andy Kelly noted in a retrospective review: "There's no doubt about it: this is a bad game. But it's an interesting one too"[^ref-12]. The game's use of photo-realistic backgrounds and real locations would influence future Sierra productions and the broader adventure game industry.

The game also serves as a historical artifact of early 1990s attitudes toward policing and urban crime. As Jimmy Maher noted in The Digital Antiquarian: "the jingoistic Gates game is a prime case in point" when discussing games that failed to handle complex social questions with appropriate nuance[^ref-4].
...
- **Previous:** [[1991 - Police Quest III - The Kindred]] (Sonny Bonds storyline)
- **Next:** The Police Quest series evolved into the [[1995 - Police Quest - SWAT|SWAT]] tactical action series
