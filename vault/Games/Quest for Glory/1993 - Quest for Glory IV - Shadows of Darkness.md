---
title: 'Quest for Glory: Shadows of Darkness'
release_year: 1993
...
> **Producer:** Oliver Brelsford[^ref-1]
> **Programmer:** Henry Yu[^ref-1]
> **Artist:** Marc Hudgins[^ref-1]
> **Composer:** Aubrey Hodges[^ref-1]
> **Engine:** SCI2 (Sierra Creative Interpreter)[^ref-3][^ref-5]
> **Platforms:** MS-DOS, Windows[^ref-1]
> **Release Year:** December 1993 (floppy), September 1994 (CD)[^ref-1]
> **Series:** Quest for Glory
> **Protagonist:** The Hero
...
The gameplay continued with Quest for Glory III's graphical, point-and-click interface[^ref-1]. The game introduced a new combat system with a sideways perspective of fights and allowed players to check an option to let the computer fight the battles automatically[^ref-1][^ref-3].
...
### Production
Quest for Glory IV features darker themes while maintaining the humor of previous games through methods like incorporating Boris Karloff and Peter Lorre parodies[^ref-1]. The game was inspired by gothic fiction, "old horror movies and books about vampires and werewolves"[^ref-1]. Development ran late, forcing Sierra to ship the floppy version with inadequate testing[^ref-1]. The CD version released the following year was much improved[^ref-1]. The GOG digital re-release has since resolved many remaining bugs[^ref-1].

The CD-ROM version was the first game in the series to feature voice actors, including John Rhys-Davies as the Narrator (whose recording took more than three weeks), Jennifer Hale as Katrina, and Bill Farmer as Leshy[^ref-1][^ref-4].
...
- Platform releases: December 1993 (floppy DOS), September 1994 (CD DOS/Windows)[^ref-1]

### Slavic Folklore and Lovecraftian Influences

The game draws heavily from Eastern European mythology and cosmic horror[^ref-23]:
- Mordavia is inspired by Slavic folklore, Gothic fiction, and "old horror movies and books about vampires and werewolves"[^ref-1]
- The Dark One Avoozl is described as a Cthulhu pastiche, likely referencing the Slavic deity Chernobog[^ref-1][^ref-23]
...
- Windows 3.x version does not work on 64-bit Windows[^ref-5]

**Fan Enhancements:**[^ref-5]
...
- Quest for Glory Anthology (1996)[^ref-6]
- Quest for Glory Collection Series (1997)[^ref-6]
- Quest for Glory 1-5 (GOG, Steam)[^ref-11][^ref-12]
...
- [Steam – Quest for Glory 1-5](https://store.steampowered.com/app/502750)
...
- [Wikipedia – Quest for Glory: Shadows of Darkness](https://en.wikipedia.org/wiki/Quest_for_Glory%3A_Shadows_of_Darkness) – encyclopedia article
- [PCGamingWiki – Quest for Glory: Shadows of Darkness](https://www.pcgamingwiki.com/wiki/Quest_for_Glory%3A_Shadows_of_Darkness) – technical fixes
- [Sierra Fandom Wiki – Quest for Glory IV](https://sierra.fandom.com/wiki/Quest_for_Glory%3A_Shadows_of_Darkness) – detailed game information
- [Quest for Glory Fandom Wiki](https://questforglory.fandom.com/wiki/Quest_for_Glory_IV%3A_Shadows_of_Darkness) – series wiki
