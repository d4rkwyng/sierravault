...
async function startWatching(
  ...
  // content/ is generated + gitignored; don't treat gitignored paths as ignored
  // (ignorePatterns below still handles .obsidian/private/templates)
  const gitIgnoredMatcher = (_fp: string) => false
